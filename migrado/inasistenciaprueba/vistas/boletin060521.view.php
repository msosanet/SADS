						...
						{ 
							...
							{ 		//echo "pase";			 
								...
								{$ausentec=$ausentec+0.50;
								 ...
								 echo "<td align='center' bgcolor='#ffd700'>P/TT</td>";}
							...
							{	
								...
								{$ausentec=$ausentec+1;
								 $injust++;
								 echo "<td align='center' bgcolor='#ff0000'>AI</td>";
								}	
								if ($rowz['injus']=="3") //si es ausente con permanencia
								{$ausentec=$ausentec+1;
								 $presente=$presente+0;				
								 echo "<td align='center' bgcolor='#ffd700'>AP</td>";}
								if ($rowz["injus"]=="0")
								{$ausentec=$ausentec+1;
								 $just++;
								 echo "<td align='center' bgcolor='#ff0000'>AJ</td>";}	
								if ($rowz["injus"]=="2")
								{$ausentec=$ausentec+0.25;
								 $presente=$presente+0.75;				
								 echo "<td align='center' bgcolor='#ffd700'>T</td>";}	
								if ($rowz["injus"]=="4")
								{$ausentec=$ausentec+0.50;
								 $presente=$presente+0.50;				
								 echo "<td align='center' bgcolor='#ffd700'>TT</td>";}									 
							} //ELSE SI NO ES EF
						} //SI ES 1
						...
						{$fi=0;
						 ...
						 $ausentez=mysql_query("SELECT * FROM alumnos_faltas WHERE fecha='$fecha' AND dni='".$row['dni']."'");
							...
							{ 
								...
								if ($fi==2)
								{echo "<td align='center' bgcolor='#ff0000'>AI|AI</td>";}
								if ($fj==2)
								{echo "<td align='center' bgcolor='#ff0000'>AJ|AJ</td>";}
								if ($ft==2)
								{echo "<td align='center' bgcolor='#d78100'>T|T</td>";}
								if ($ftt==2)
								{echo "<td align='center' bgcolor='#d78100'>TT|TT</td>";}
								if ($fi==1 && $fj==1)
								{echo "<td align='center' bgcolor='#ff0000'>AI|AJ</td>";}
								if ($fi==1 && $ft==1)
								{echo "<td align='center' bgcolor='#ff0000'>AI|T</td>";}
								if ($fi==1 && $fap==1)
								{echo "<td align='center' bgcolor='#ff0000'>AI|AP</td>";}
								if ($fi==1 && $ftt==1)
								{echo "<td align='center' bgcolor='#ff0000'>AI|TT</td>";}
								if ($fj==1 && $ft==1)
								{echo "<td align='center' bgcolor='#ff0000'>AJ|T</td>";}
								if ($fj==1 && $ftt==1)
								{echo "<td align='center' bgcolor='#ff0000'>AJ|TT</td>";}
								if ($fj==1 && $fap==1)
								{echo "<td align='center' bgcolor='#ff0000'>AJ|AP</td>";}
								if ($fap==2)
								{echo "<td align='center' bgcolor='#ff0000'>AP|AP</td>";}
								if ($fap==1 && $ft==1)
								{echo "<td align='center' bgcolor='#ff0000'>AP|T</td>";}
								if ($fap==1 && $ftt==1)
								{echo "<td align='center' bgcolor='#ff0000'>AP|TT</td>";}
								if ($ft==1 && $ftt==1)
								{echo "<td align='center' bgcolor='#d78100'>T|TT</td>";}
