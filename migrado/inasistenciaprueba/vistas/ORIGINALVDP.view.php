...
<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Datos de:&nbsp;<font color="ff0000"><?echo $filatt[apellido] ?>,&nbsp;<?echo $filatt[nombre] ?></font></p></p>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Telefonos:&nbsp;<font color="ff0000"><?echo $filatt[telefono] ?>&nbsp;&nbsp;</font></p>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Direccion:&nbsp;<font color="ff0000"><?echo $filatt[direccion] ?>&nbsp;&nbsp;</font></p>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Numero:&nbsp;<font color="ff0000"><?echo $filatt[numero] ?>&nbsp;&nbsp;</font></p>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Celular:&nbsp;<font color="ff0000"><?echo $filatt[celular] ?>&nbsp;&nbsp;</font></p>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Mail:&nbsp;<font color="ff0000"><?echo $filatt[mail] ?>&nbsp;&nbsp;</font></p>
					</td>
</tr>			
...
<?
	...
	{	
		...
		echo "<td bgcolor='#EAEAEA' align='center'>".$fila81[3]."</td>";
		echo "</tr>";
	...
	while ($fila82 = mysql_fetch_array($result81))
		{
			echo "<tr>";
			echo "<td bgcolor='#EAEAEA' align='center'>".$fila82[0]."</td>";
			echo "<td bgcolor='#EAEAEA' align='center'>".$fila82[1]."</td>";
			echo "<td bgcolor='#EAEAEA' align='center'><a href='ORIGINALVEF.php'>".$fila82[2]."</a></td>";
			echo "<td bgcolor='#EAEAEA' align='center'>".$fila82[3]."</td>";
			echo "</tr>";
		}
...
$turnoc='E';
 ...
 <div align="center">
					...
					<table border="1" bordercolor="#000000" style="background-color:#FFFFFF" width="895" cellpadding="1" cellspacing="0">
	<tr>
		<td width="895" bgcolor="#EAEAEA" align="center" colspan="7"><font color="FF0000"><b>HORARIO DE <?echo $cursotextx; ?> TURNO <?echo $turnoc; ?></b></font></td>
	</tr>	
	<tr>
