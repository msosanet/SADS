...
$j=0;
$result = mysql_query ("SELECT m.descripcion,m.idmateria,D.dni,h.hora FROM horariox h, materias m, docente D, matcur mc WHERE h.idmateria!='65' AND h.idmateria=m.idmateria AND h.idcurso='$cursox' AND h.dia='$dia' AND mc.idcurso='$cursox' AND mc.idmateria!='65' AND h.idmateria=mc.idmateria AND mc.iddocente=D.dni ORDER BY h.hora ASC");
...
$sql2="UPDATE matcur SET iddocente='$docente[$i]' WHERE idcurso='$curso' AND idmateria='$materiaidx[$i]'";
//echo $sql;
