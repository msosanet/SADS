...
$resultt = mysql_query ("SELECT * FROM comunicado WHERE codigo = '$actor'");
...
<form method="GET" action="modif_comu.php?nota=<?php echo $actor?>">
...
?>
				<tr>
					...
					<p align="left" class="text1b">Modificar Comunicados</p>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						<tr>
							...
							<td width="174" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Comunicado Nº:</td>
						...
						?>
							<td width="190" bgcolor="#EAEAEA" align="right">Descripcion:
							</td></font>
...
if (mysql_query ("UPDATE comunicado SET descripcion='$descripcion', agente='$agente' where codigo='$actor'"))
{	
				?>
				<script>
