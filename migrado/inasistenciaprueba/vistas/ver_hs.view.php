...
$result = mysql_query ("SELECT * FROM diario WHERE dni = '$actor' and fecha >='$fdesde'  and fecha <= '$fhasta' order by fecha" );
...
?>				<tr>
					...
					<br><br>
					<p align="center" class="text1b"><? if($hayerrores) { echo "<h4><font color=red>Existen errores en el ingreso de datos, estÃ¡n marcado con color ROJO</font></h4>";} ?>
</p><div align="left">
	...
	<table border="0" width="779" id="table1" cellspacing="0" cellpadding="0">
		<tr>
			<td valign="top">
			<div align="center">
				<div align="center">Docente: <B><?php echo utf8_encode($filatt[apellido]);?></B>,<B><?php echo $filatt[nombre];?></B>
