...
echo "<form method='GET' action='asistencia2.php'>";
...
?>
	<td align="left">&nbsp;<input type="text" name="fecha" id="fecha" value="<?echo $_GET["fecha"]?>" maxlength="16"/>
...
$materia=$_GET['materia'];
	...
	$sql = "INSERT INTO alumnos_faltas2 VALUES ('$valor','$hoy','General','$falta','$injus')";
	//echo $sql;
	//echo  "<br>";
	mysql_query($sql);
	//echo $injus;
