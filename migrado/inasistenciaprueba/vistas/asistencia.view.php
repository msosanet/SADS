...
$sql= "SELECT a.dni,CONCAT(a.apellido,  ' ', a.nombre) as alumno FROM alumno a, cursa c WHERE c.control='1' AND c.curso='$curso' AND c.divi='$division' AND c.anio='$ano' AND c.alumno=a.dni ORDER by alumno";
