...
if ($identificacion==2)
{
$resultmotivo = mysql_query ("SELECT * FROM motivos2 order by codigo"); 
}
...
<form method="POST" action="cargar_ina2.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Cargar Inasistencia a No Docentes</p>
...
if (mysql_query ("INSERT INTO ausentes VALUES (0,'$dni','$fecha_desde','$fecha_desde','$hora','$motivo','$graba','$observaciones','$now')"))
	{		
