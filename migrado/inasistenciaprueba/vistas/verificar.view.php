...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Verificar.</p>
						</p>
					<p align="center">&nbsp;
					...
					<table border="0" width="62%">
						<tr>
							<td align="right" width="36%">Ingrese el codigo de validacion:</td>
...
$docente=$_GET['descripcion'];
	...
	$_pagi_sql="SELECT * FROM autogestion WHERE id='$docente'";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						<tr>
							...
							&nbsp;Este codigo valida la regularidad del siguiente alumno</td>
						</tr>
						<tr>
							<td width="100" bgcolor="#808080" align="center" height="36">DNI</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Alumno</td>
							<td bgcolor="#808080" width="100" align="center" height="36">FECHA DE GENERACION</td>
3
						</tr>
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[nomyape];?></td>
