...
<!-- ************************** MENU DESLIZABLE ***************************-->
<ul id=menu_slide>
    <li><a href="http://inasistencias.colegiosobral.edu.ar/cargar_ina.php?actor=<? echo $dni; ?>&ident=1">CARGAR INASISTENCIA</a>
    <li><a href="http://inasistencias.colegiosobral.edu.ar/sube2.php?actor=<? echo $dni; ?>&ident=1">CARGAR INASIST JUSTIFICADA</a>
    <li><a href="http://inasistencias.colegiosobral.edu.ar/leg_unif.php?actor=<? echo $dni; ?>&ident=1">VER DATOS DE DOCENTE</a>
</ul>			      
<!-- ************************** FIN MENU DESLIZABLE ***************************-->
...
<table border="0" width="100%">
    <tr align="right">
        ...
        <td>                                                                     
            <form method="GET" action="ver_ina3.php?actor=<? echo $dni2; ?>" name="form20">
<!-- ************** LISTA DE DOCENTES PARA ELEGIR *********************************** -->                    
			
            Otro docente: <select autofocus="true" style="border: 1px solid #888888; background-color: #ffffff; border-radius: 5px; padding: 4px 0 4px 0; box-shadow: 0 0 2px #555555;" size="1" name="actor">
            <option>- - - - - -</option>
...
<form method="GET" action="ver_ina3.php?actor=<? echo $dni; ?>" name="form10">
