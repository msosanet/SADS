...
<form method="POST" action="add_motivo2.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Cargar Motivos de Pomys</p>
...
$resultdocente = mysql_query ("SELECT * FROM motivos2 where descripcion='$desc'");
$yaesta = mysql_num_rows($resultdocente); 

if ($yaesta == 0)
{

	if (mysql_query ("INSERT INTO motivos2 VALUES (0,'$desc')"))
	{		
