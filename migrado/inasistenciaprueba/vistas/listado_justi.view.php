...
<form method="GET" action="listado_justi.php">
...
?>
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Filtrar por Fecha (Justificadas)</p>
						</p>
					<p align="center">&nbsp;
...
{ 
	...
	$_pagi_sql="SELECT * FROM justificados WHERE fecha_desde >='$fecha_desde'  and fecha_hasta <= '$fecha_hasta' and motivo != 13 and motivo != 16 and motivo != 17 and motivo != 18 and motivo != 19 and motivo != 21 and motivo != 22 and motivo != 25 and motivo != 24 order by docente";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="40" align="center"  height="36">Parte</td>
							<td bgcolor="#808080" width="40" align="center"  height="36">Justif.</td>
							<td bgcolor="#808080" width="40" align="center"  height="36">Aviso</td>
							<td bgcolor="#808080" width="30" align="center"  height="36">OK</td>
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[parte];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[justificativo];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[aviso];?></td>
