...
<title>INFORMÁTICA - OCULTAR TICKET</title>
...
<!-- *********** FORMULARIO TICKET A OCULTAR ***************** -->
<div id="nov_form_container" align="left">

<form name="form1" method="post" action="informat_tkt_ocultar.php">
...
<?
    ...
    $hora_finalizada = $_POST['hora_finalizada'];
            ...
            $grabartkt = mysqli_query($mysqli, "UPDATE informat SET ocultar = '1' WHERE id = $id");
            ...
            ?>
				<script>
				var answer=alert("El ticket se ocultó Correctamente")
				</script>
