...
?>
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Generar Listado Inasistencias</p>
						</p>
					<p align="center">&nbsp;
...
{ 
	...
	$_pagi_sql="SELECT * FROM listado WHERE fecha_desde >='$fecha_desde'  and fecha_hasta <= '$fecha_hasta' and motivo != 13 and motivo != 16 and motivo != 17 and motivo != 18 and motivo != 19 and motivo != 21 and motivo != 22 and motivo != 25 and motivo != 24 order by docente";
