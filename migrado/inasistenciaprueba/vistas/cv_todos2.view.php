...
<form method="GET" action="cv_todos2.php">
...
<br><br>
		...
		?> 
						...
						<tr>
							...
							<td width="10" bgcolor="#EAEAEA" align="center"><?echo $tribu[tribu];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $filaz[descripcion];?></td>
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="leg_unif.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Horario"></a></td>
