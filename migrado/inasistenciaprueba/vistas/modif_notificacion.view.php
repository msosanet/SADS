...
$conexion = conectar ();
$actor=$_GET["nota"];
$resultt = mysql_query ("SELECT * FROM notificaciones WHERE codigo = '$actor'");
					...
					<div align="center">
						<table border="0" id="table1" cellpadding="4" cellspacing="2">
							<tr height="30">
								...
								<td bgcolor="#EAEAEA" width="50" align="center"><?echo $actor; ?></td>
...
?>
							...
							<td bgcolor="#EAEAEA" align="left"><input type="text" name="descripcion" size="70" maxlength="60" value="<?echo $filatt['descripcion']; ?>" /></td>
						</tr></font>
						<tr height="30">
...
if (mysql_query ("UPDATE notificaciones SET descripcion='$descripcion', agente='$agente' where codigo='$actor'"))
{	
				?>
				<script>
