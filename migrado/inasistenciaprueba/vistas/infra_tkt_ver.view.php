...
<title>INFRAESTRUCTURA - VER TICKET</title>
...
<form name="form1" method="post" action="infra_tkt_modificar.php">
    ...
    <p align="center" class="titulo">VER TICKET INFRAESTRUCTURA</p>
    <hr>
    ...
    <p class="titulo">
       ...
       HORA: <input type="text" name="hora_solicitud" size="10" value="<? echo $hora_solicitud; ?>">
    </p>
