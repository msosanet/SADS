...
?>	
				<tr>
					...
					<table border="0" width="62%">
						<tr>
							<td align="right" width="36%">Ingrese el Apellido, dni (con puntos) o parte de el:</td>
...
{ 
	...
	$_pagi_sql="SELECT * FROM alumnos WHERE alumno like'%$descripcion%' or dni like'%$descripcion%'";
...
<br><br>
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="cargar_nov.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar Inasistencia"></a></td>
