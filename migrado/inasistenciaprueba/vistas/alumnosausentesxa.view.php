...
<form method="GET" action="alumnosausentesxa.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Buscar por Apellido.</p>
						</p>
					<p align="center">&nbsp;
...
$ano=date("Y")-1;
	...
	$_pagi_sql="SELECT a.dni,CONCAT(a.apellido, ' ', a.nombre) as alumno,c.divi,c.curso FROM alumno a, cursa c WHERE c.anio='$ano' AND c.control='1' AND c.alumno=a.dni AND a.apellido like'%$descripcion%'";
...
<br><br>
		...
		?> <table border='1' id='customers' style='width: 75%;'>
						<tr>
						...
						<tr>
							...
							<td bgcolor="#808080" width="200" align="center" height="36">Nombre y Apellido</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Curso</td>
							<td bgcolor="#808080" width="118" align="center"  height="36">Division</td>	
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ver_alu.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar Inasistencia"></a></td>
