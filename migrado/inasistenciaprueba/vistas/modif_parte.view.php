...
<form method="GET" action="modif_parte.php?actor=<?php echo $dni?>">
...
?>
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Parte a modificar de &nbsp;<?echo $filadocente['apellido'];?>&nbsp;<?echo $filadocente['nombre'];?></p>
						</p>
					<p align="center">&nbsp;
...
<?
	...
	$_pagi_sql="SELECT * FROM partediario WHERE docente='$dni' order by fecha";
...
<TEXTAREA COLS=60 ROWS=5 NAME="observaciones"> </TEXTAREA>
 ...
 <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="80" align="center" height="36">Fecha</td>
							...
							<td bgcolor="#808080" width="80" align="center"  height="36">Obligaciones</td>
							<td bgcolor="#808080" width="80" align="center"  height="36">curso/div/turno</td>
							<td bgcolor="#808080" width="80" align="center"  height="36">Marcar</td>								
		...
		{	
			...
			$resultmot = mysql_query ("SELECT * FROM motivos WHERE codigo = '$fila2[falta]' ");
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[obligaciones];?></td>
...
foreach ($_GET["afectado"] as $afectado)
	{
		if (mysql_query ("update partediario set observaciones='$obs' where codigo=$afectado"))
		{	
