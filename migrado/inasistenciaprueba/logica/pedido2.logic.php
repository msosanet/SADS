...
$actor=$_GET['actor'];
 ...
 $result = mysql_query ("SELECT ausentes.motivo,ausentes.docente, docentes.apellido, docentes.nombre, ausentes.fecha_desde, ausentes.fecha_hasta,ausentes.observaciones FROM docentes, ausentes WHERE docentes.dni='$actor' and ausentes.docente='$actor' AND ausentes.fecha_desde >= '$desde' AND ausentes.fecha_hasta <= '$hasta' order by docentes.dni, docentes.apellido,docentes.nombre, ausentes.fecha_desde;");
