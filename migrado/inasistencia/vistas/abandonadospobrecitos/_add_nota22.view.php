...
$_POST['a']=date("Y");
  ...
  if (isset($_POST["submitx"])) {
     ...
     if (trim($_POST["aa"]) == '') { $errorfechavolvio = 1; $hayerrores = 1; };
     if (trim($_POST["dd"]) == '') { $errorfechavolvio = 1; $hayerrores = 1; };
     if (trim($_POST["mm"]) == '') { $errorfechavolvio = 1; $hayerrores = 1; };
...
<form method="POST" action="add_nota22.php">
</p>
<div align="center">
...
<tr>
						...
						?>
							...
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="text" name="numero" size="15" maxlength="15" value="" /></td>
							</td>
						<?
...
<tr>
						...
						<?
	  					if ($errorfechavolvio==1) {$color="#FF0000";}
						else{$color="#000000";}
						?>
							...
							<input type="text" name="dd" size="2" maxlength="2" value="<?echo $_GET['dd']; ?>" />
							-
							<input type="text" name="mm" size="2" maxlength="2" value="<?echo $_GET['mm']; ?>" />
							-
							<input type="text" name="aa" size="4" maxlength="4" value="<?echo $_GET['aa']; ?>" /> 
							(DD-MM-AAAA)</td>
...
else
{
	...
	$asunto=$_POST['asunto'];
	$fechacero=$_POST['aa']."-".$_POST['mm']."-".$_POST['dd'];
