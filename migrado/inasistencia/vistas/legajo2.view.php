...
?>
				<tr>
					...
					<p align="left" class="text1b">Ver Legajos</p>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						<tr>
							...
							<td width="190" bgcolor="#EAEAEA" align="right">
							Id Reloj:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="text" name="celular" size="20" maxlength="20" value="<?echo $filatt['idreloj'];?>" /></td>
							</td>
...
if (mysql_query ("UPDATE docentes SET nombre='$nombre',apellido='$apellido',direccion='$direccion',mail='$mail',sexo='$sexo',identificacion=$tipo,telefono='$telefono',piso='$piso',depto='$depto',numero=$numero,barrio='$barrio', celular='$celular' , idreloj='$idreloj' where dni='$actor'"))
{	
				?>
				<script>
