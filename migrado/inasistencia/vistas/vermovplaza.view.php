...
<table class="elegant-table">
    <tr>
		...
		<td><a href=vermovplaza.php?borrar=<? echo $filamc[id];?> target="_blank" onclick="return confirm('Â¿Leo, estas seguro que queres borrar la plaza?');"><img src="borrar.png" width="32" height="32"></img></a></td>
		<??>
	 </tr>
...
?>
    ...
    <!-- Puedes agregar mÃ¡s filas de datos aquÃ­ -->
</table>
<?
