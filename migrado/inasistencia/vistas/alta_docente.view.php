				...
				<tr>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						?>
							...
							<input type="text" name="dni" size="8" pattern="\d{1,2}\d{3}\d{3}$" value="<?echo $_POST['dni']; ?>" required />
							</td>
						...
						?>
							...
							<input type="text" name="apellido" size="40" maxlength="40" value="<?echo $_POST['apellido']; ?>" required />
							</td>												
						<?
						...
						?>
							...
							<input type="text" name="nombre" size="40" maxlength="40" value="<?echo $_POST['nombre']; ?>" required />
							</td>
						...
						<tr>
							...
							Calle:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="text" name="calle" size="30" maxlength="30" value="<?echo $_POST['calle'];?>" required /></td>
							</td>
							...
							<td width="190" bgcolor="#EAEAEA" align="right">
							E-mail:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="email" name="mail" size="30" maxlength="100" value="<?echo $_POST['mail'];?>" required /></td>
							</td>
						...
						<tr>
							...
							<td width="190" bgcolor="#EAEAEA" align="right">
							Celular:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="text" name="celular" size="20" maxlength="20" value="<?echo $_POST['celular'];?>" required /></td>
							</td>
						...
						<tr>
							...
							<td width="190" bgcolor="#EAEAEA" align="right">
							Fecha Nac.:</td>
							<td bgcolor="#EAEAEA" width="265" align="left">DD-MM-AAAA<input type="text" name="dia" size="2" maxlength="2" pattern="[0-2][0-9]|3[0-1]$" value="<?echo $_POST['dia'];?>" />-<input type="text" name="mes" size="2" maxlength="2" pattern="(^0?[1-9]$)|(^1[0-2]$)" value="<?echo $_POST['mes'];?>" />-<input type="text" name="anio" size="4" maxlength="4" pattern="(19|20)\d{2}$" value="<?echo $_POST['anio'];?>" /></td>
							</td>
						...
						<tr>
							...
							<td width="190" bgcolor="#EAEAEA" align="right">
							Titulo:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="text" name="titulo" size="50" maxlength="100" value="<?echo $_POST['titulo'];?>" required /></td>
							</td>
...
if ($yaesta == 0)
{
	...
	$insertaDOC="INSERT INTO docentes VALUES ('$dni','$apellido','$nombre','$calle','$telefono','$tipo','$numero','$sexo','$piso','$depto','$barrio','$celular','$mail',$cargo,$reloj,'$fnac','$tribu','$titulo','$now')";
	//echo $insertaDOC;
