...
<form method="GET" action="calificadores.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Buscar por Curso y Año.</p>
						</p>
					<p align="center">&nbsp;
					...
					<table border="0" width="62%">
						<tr>
							<td align="right" width="36%">Ingrese el Curso o parte de el:</td>
						...
						<tr>
							<td align="right" width="36%">Ingrese el Año o parte de el:</td>
							<td align="right">&nbsp;<input type="text" name="descripcion2" id="descripcion2" size="4" maxlength="4" value="" /></td>
							<td align="right" rowspan="3" width="389" >
							<p align="center">&nbsp;<p align="center">&nbsp;<p align="center">&nbsp;<p align="center">&nbsp;</td>
						</tr>
...
{ 
	...
	$_pagi_sql="SELECT distinct curso, anio FROM alumno_curso WHERE curso like'%$descripcion%' and anio like'%$descripcion2%'";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="200" align="center" height="36">Acciones</td>
