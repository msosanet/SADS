...
$dni=$_GET['dni'];
	...
	{
	$fecha=$_GET['fecha'];
	$sql1 = "SELECT ac.dni,CONCAT(ac.apellido, ' ', ac.nombre) as alumno,c.curso,c.divi,af.tipo,af.injus FROM alumno ac,alumnos_faltas af, cursa c WHERE ac.dni=af.dni AND ac.dni=c.alumno AND c.control='1' AND c.anio='$ano' AND ac.dni='$dni' AND af.fecha='$fecha' ORDER BY alumno,c.curso,c.divi";
	}
	else
	{
	$sql1 = "SELECT ac.dni,CONCAT(ac.apellido, ' ', ac.nombre) as alumno,c.curso,c.divi,af.tipo,af.injus FROM alumno ac,alumnos_faltas af, cursa c WHERE ac.dni=af.dni AND ac.dni=c.alumno AND c.control='1' AND YEAR(af.fecha) = YEAR(DATE()) AND ac.dni='$dni' ORDER BY alumno,c.curso,c.divi";	
	}
echo $sqll;
...
$sql = "SELECT ac.dni,CONCAT(ac.apellido, ' ', ac.nombre) as alumno,c.curso,c.divi,af.tipo,af.injus FROM alumno ac,alumnos_faltas af, cursa c WHERE c.control='1' AND c.anio='$ano' AND ac.dni=af.dni AND ac.dni=c.alumno AND af.fecha='$fecha' ORDER BY alumno,c.curso,c.divi LIMIT ".(($page-1)*20).",20";
