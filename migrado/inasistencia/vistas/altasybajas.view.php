...
$resultmotivo = mysql_query ("SELECT * FROM materia_cargo WHERE activo=1 order by plaza"); 
...
function validarFormulario() {
    var caracterSelect = document.getElementById("caracterSelect");
	var motivoSelect = document.getElementById("motivoSelect");
    if (caracterSelect.value === "10") {
        alert("Por favor, selecciona una opción válida en Sit. Revi.");
        return false; // Evita el envío del formulario
    }
	if (motivoSelect.value === "770") {
        alert("Por favor, selecciona una opción válida en para Cargo/Materia");
        return false; // Evita el envío del formulario
    }
...
<form method="POST" action="altasybajas.php?dni=<? echo $dni; ?>" onsubmit="return validarFormulario()">
...
<div align="left">
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						<tr>
                          ...
                          <select size="1" autofocus="true" name="motivo" id="motivoSelect"> <!-- ****************************LISTA MOTIVOS -->
						  <?	
					...
					if ($myrow6[curso]=="")	echo "<option value=" . $myrow6[id] . ">" . $myrow6[plaza] . " - " . $myrow6[nombre] ."</option>";
						...
						<td width="174" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Sit. Revi:</td>
						  <td bgcolor="#EAEAEA" width="268" align="left">  
						  <select size="1" autofocus="true" name="caracter" id="caracterSelect"> 
						...
						<td width="174" bgcolor="#EAEAEA" align="right">Mov. Activo?</td>
						  <td bgcolor="#EAEAEA" width="268" align="left"><input type="checkbox" name="activo" value="1" checked>
						...
						<!--
						<td width="174" bgcolor="#EAEAEA" align="right">Esta el movimiento enviado?</td>
						  <td bgcolor="#EAEAEA" width="268" align="left"><input type="checkbox" name="enviado" value="1">
...
if ($fecha_desde == "") $fecha_desde=$fecha_inicio;
	...
	if ($activo =="") $activo=0;
	if ($activo==1) //CHEQUEAMOS SI EL DOCENTE TIENE UNA MATERIA ACTIVA PARA CAMBIARLE EL ESTADO A ACTIVO DOCENTE (VER CHECKACTIVO.PHP QUE HACE LA INVERSA)
			{	
			estadodocente($dni,"alta");	
			}
...
if (mysql_query ("INSERT INTO alta_baja VALUES (0,$materia,'$dni','$fecha_desde','$fecha_hasta',$caracter,'$observaciones',$enviado,'$fecha_inicio','$graba',$activo)"))
	{		
