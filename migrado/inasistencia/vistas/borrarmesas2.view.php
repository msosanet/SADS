...
<form method="GET" action="borrarmesas2.php?actor=<?php echo $dni?>">
...
?>
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Borrar Mesas creadas</p>
						</p>
					<p align="center">&nbsp;
...
else
{
		...
		if (mysql_query ("TRUNCATE TABLE docentes_mesas"))
		{	
