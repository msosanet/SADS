...
<form method="GET" action="inasistencias2.php">
...
{ 
	...
	$_pagi_sql="SELECT * FROM docentes WHERE apellido like'%$descripcion%' and identificacion=2";
...
<br><br>
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="cargar_ina2.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar Inasistencia"></a></td>
