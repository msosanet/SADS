...
$injustificadasQ=("SELECT SUM(i.valorfalta) as total FROM alumnos_faltas a, injus i WHERE i.id=0 AND a.injus=i.id AND MONTH(fecha) = '".$mess."' AND YEAR(fecha) = '".$year."' AND a.dni='".$row['dni']."'");
$injustificadax=mysql_query($justificadasQ);
if ($justificadax) {
