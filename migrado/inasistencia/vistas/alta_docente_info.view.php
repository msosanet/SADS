...
$resultt = mysql_query ("SELECT * FROM tomas WHERE id = $dato");
...
<form method="POST" action="alta_docente_info.php">
</p>
<div align="center">
				...
				<tr>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						?>
							...
							<input type="text" name="dni" size="8" maxlength="8" value="<?echo $filatt['dni']; ?>" />
							</td>
...
if ($yaesta == 0)
{
	...
	if (mysql_query ("INSERT INTO docentes VALUES ('$dni','$apellido','$nombre','$calle','$telefono','$tipo','$numero','$sexo','$piso','$depto','$barrio','$celular','$mail',$cargo,$reloj,'$fnac','$tribu','$titulo')"))
	{		
