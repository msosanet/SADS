...
<form method="POST" action="add_materias3.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<td>
					<br>
					<p align="left" class="text1b">Alta de Materias de: <?echo $filadocente[apellido];?>,&nbsp;<?echo $filadocente[nombre];?> </p><br>
<p align="center" class="text1b"><font color="FF0000"><b> "Unicamente Educación Física"</b></font></p>
...
<b>Se deben cargar los siguiente datos la cantidad de veces por cada Materia que el docente tenga. </b><br>
...
<?php 		$turno='M';
		$result77 = mysql_query ("SELECT * FROM horas where turno='MEF' order by desde");
...
<?php 		$turno='M';
		$result78 = mysql_query ("SELECT * FROM horas where turno='TEF' order by desde");
...
<?php 		$turno='M';
		$result79 = mysql_query ("SELECT * FROM horas where turno='VEF' order by desde");
