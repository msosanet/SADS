...
<title>CARGAR INASIS JUSTIF</title>
...
<form method="GET" action="sube.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Buscar por Apellido o dni.</p>
						</p>
					<p align="center">&nbsp;
...
<br><br>
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="sube2.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar Inasistencia"></a></td>
