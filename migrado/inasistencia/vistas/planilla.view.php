...
<title>GENERA PLLA INASISTENCIAS</title>
...
?>
<meta http-equiv='refresh' content='0; URL=planilla2.php?'>
<?
}
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Generar planilla de Inasistencias</p>
						</p>
					<p align="center">&nbsp;
					</p>
					<div align="left">
						...
						<tr>	
							...
							<td bgcolor="#EAEAEA" width="225" align="left">
 							<input type="text" name="fecha_desde" autofocus id="fecha_desde" value="<?echo $_GET["fecha_desde"]?>" maxlength="10"/>
						...
						<tr>
							...
							<p align="center">
									<input type="submit" value="   Generar   " name="muestra2" style="border: 1px solid #C0C0C0; padding-right: 3px; background-color: #EBEBEB; font-weight:700; float:center" /></td>
						</tr>
					</table>
