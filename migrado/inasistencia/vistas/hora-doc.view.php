...
<form method="GET" action="hora-doc.php">
...
$fecha_q = $dias[date('N', strtotime($fecha))];
	...
	$_pagi_sql="SELECT * FROM diario, docentes WHERE docentes.identificacion= 1 and diario.dni = docentes.dni and fecha ='$fecha' order by diario.horario";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#ffffff" width="100" align="center"  height="36"><b>Horario de Salida</td></b>
							<td bgcolor="#ffffff" width="80" align="center" height="36"><b>Salida</td></b>
		...
		{	
			...
			$result5 = mysql_query ("SELECT * FROM horarios WHERE dni = '$fila2[dni]' and cod_dia=$fecha_q ");
			$fila5 = mysql_fetch_array($result5);
			$result6 = mysql_query ("SELECT * FROM diario WHERE dni = '$fila2[dni]' and tipo='Salida' and fecha ='$fecha' ");
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila6['horario'];?></td>
