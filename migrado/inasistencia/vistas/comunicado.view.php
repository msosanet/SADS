...
?>	
				<tr>
					...
					<table border="0" width="70%" id="table1" cellpadding="2" cellspacing="4">
						...
						?>
							<td width="20%" bgcolor="#EAEAEA" align="center"><font color="<?echo $color;?>">Descripción del comunicado:</td>
							...
							<td bgcolor="#EAEAEA" width="10%" align="center"><?echo "Año: " . date ("Y");  ?></td>												</tr>
						<tr height="30">
