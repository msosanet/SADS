...
<form method="get" action="nov_docentes_vertodo.php">
...
<?
$_pagi_sql="SELECT * FROM nov_docentes WHERE borrado=1 AND categoria = 'doc' AND fecha > '2024-12-01' ORDER BY codigo DESC";
$_pagi_cuantos=20000;
...
<!-- ************* NOVEDADES DOCENTES ********************** -->
<div id="nov_container_ancho" align="left">
...
<div id="novedad">
  ...
  <? echo "<p class='editar' align='right'><a href=\"nov_aviso_modificar.php?codigo=$fila2[codigo]\">>>Editar</a> <a href=\"nov_aviso_borrar.php?codigo=$fila2[codigo]\">>>Borrar</a></p>"; ?>
</div>
<? }	?>
