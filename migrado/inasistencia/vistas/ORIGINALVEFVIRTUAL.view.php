...
<form method="GET" action="ORIGINALVEFVIRTUAL.php">
...
<tr>
					...
					<td>
					<br>
					<p align="left" class="text1b">Horario de Educacion Fisica Virtual</p><br>
 ...
 <div align="center">
	...
	<tr>
		<td width="895" bgcolor="#EAEAEA" align="center" colspan="7"><font color="FF0000"><b>HORARIO EDUCACION FISICA VIRTUAL</b></font></td>
	</tr>	
	<tr>
...
<?php 			
		...
		*/
		...
		{ 	
			...
			$consulta=("SELECT c.idcurso,c.descripcion, CONCAT(D.apellido,  ' ', D.nombre) as nombredoc,D.dni FROM curso2 c, docente D, matcurVIRTUAL mc, edfisicaVIRTUAL ef WHERE c.idcurso=mc.idcurso AND mc.iddocente=D.dni AND ef.idcurso=c.idcurso AND mc.idmateria='71' AND ef.hora=$hora AND ef.dia=$dia");
			//echo $consulta;
			...
			echo "<td bgcolor='$curso$curso' align='center' width='375' height='50'>";
		//				
			?>
			
			<a onMouseOver="javascript:highlightLink(this, '#FFFF00');" 
			   onMouseOut="javascript:unhighlightLink(this);"
               HREF="ORIGINALEFVIRTUAL.php"><font color='white' face='arial' size='2'><strong><?echo $curso?></strong></font></a>
			<br>
			<a onMouseOver="javascript:highlightLink(this, '#00FF00');" 
			   onMouseOut="javascript:unhighlightLink(this);" 
			   HREF="asigdocVIRTUAL.php?curso=<?echo $cursox?>"><font color='white' face='verdana' size='1'><?echo $docente?></font></a>
