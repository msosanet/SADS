...
$resEmp2 = mysql_query ("SELECT * FROM mesas order by dni");
...
while($datatmp2 = mysql_fetch_assoc($resEmp2)) { 
	...
	$rest4 =$rest1.".".$rest2.".".$rest3; //Compone número de DNI con puntos
...
$txttit34 = "<b>LISTADO DE TODAS LAS MATERIAS CON ALUMNOS</b>";
