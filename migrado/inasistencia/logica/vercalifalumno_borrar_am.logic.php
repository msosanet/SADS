<?PHP // OBSOLETO porque depende de los datos de $_GET para presentar curso y divisiÃ³n. Obsoleto porque estÃ¡ mal el orden de las columnas de instancias de calificaciÃ³n
session_start();
