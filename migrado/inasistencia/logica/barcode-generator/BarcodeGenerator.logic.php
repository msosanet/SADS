...
use JFilla\Barcode\Exceptions\BarcodeException;
use JFilla\Barcode\Exceptions\InvalidCharacterException;
use JFilla\Barcode\Exceptions\InvalidCheckDigitException;
use JFilla\Barcode\Exceptions\InvalidFormatException;
use JFilla\Barcode\Exceptions\InvalidLengthException;
use JFilla\Barcode\Exceptions\UnknownTypeException;
...
abstract class BarcodeGenerator
{
	...
	protected function barcode_c128($code, $type = '')
	{
		...
		$keys_b = ' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~' . chr(
				127
			);
		// special codes
	 ...
	 * as well as for future USPS use. This shall be two digits, with the second digit in the range of 0â€“4. The
	 * allowable encoding ranges shall be 00â€“04, 10â€“14, 20â€“24, 30â€“34, 40â€“44, 50â€“54, 60â€“64, 70â€“74, 80â€“84, and
	 * 90â€“94.</li><li>The Service Type Identifier shall be assigned by USPS for any combination of services requested
	 * on the mailpiece. The allowable encoding range shall be 000http://it2.php.net/manual/en/function.dechex.phpâ€“999.
	 ...
	 * allowable encoding range shall be 000000000â€“999999999 when used with a 6 digit Mailer ID and 000000-999999 when
	 ...
	 * 0, 5, 9, or 11 digits. The allowable encoding ranges shall be no ZIP Code, 00000â€“99999,  000000000â€“999999999,
	 * and 00000000000â€“99999999999.</li></ul>
