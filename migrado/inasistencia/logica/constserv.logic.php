...
$pdf->ezSetCmMargins(5,2,1.5,1.5);
...
$actor=$_GET["actor"];
$resEmp2 = mysql_query ("SELECT *,IF(fhasta LIKE '0000-00-00',1,2) paordena FROM alta_baja JOIN materia_cargo ON materia_cargo.id = alta_baja.materia WHERE docente='$actor' AND materia != 770 ORDER BY paordena, fdesde DESC");
//$resEmp2 = mysql_query ("SELECT * FROM alta_baja, materia_cargo WHERE alta_baja.docente='$actor' AND materia_cargo.id=alta_baja.materia AND materia != 770 ORDER BY alta_baja.fdesde DESC");
...
$options2 = array(
				...
				'cols'        => array(
        'hs' => array(
            'width'       => 30,  // Ancho de la columna 'id'
            'justification' => 'center' // Justificación del texto en la columna
        ),
        'materia' => array(
            'width'       => 130, // Ancho de la columna 'nombre'
            'justification' => 'left'
        ),
        'cd' => array(
            'width'       => 50, // Ancho de la columna 'precio'
            'justification' => 'center'
        ),
        'fx' => array(
            'width'       => 65, // Ancho de la columna 'precio'
            'justification' => 'center'
        ),
        'fz' => array(
            'width'       => 65, // Ancho de la columna 'precio'
        ...
        'revista' => array(
            'width'       => 60, // Ancho de la columna 'precio'
            'justification' => 'left'
        ),
        'obs' => array(
...
FROM ausentes2 a
JOIN materia_cargo m ON a.plaza = m.plaza
