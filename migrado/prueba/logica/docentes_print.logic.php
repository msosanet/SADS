...
$layout->blocks["top"][] = "pdf";$page_layouts["docentes_print"] = $layout;
...
//	process selection
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["dni"]=refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[]=$keys;
		}
	}
...
$xt->assign("dni_fieldheadercolumn",true);
$xt->assign("dni_fieldheader",true);
$xt->assign("dni_fieldcolumn",true);
$xt->assign("dni_fieldfootercolumn",true);
$xt->assign("apellido_fieldheadercolumn",true);
$xt->assign("apellido_fieldheader",true);
$xt->assign("apellido_fieldcolumn",true);
$xt->assign("apellido_fieldfootercolumn",true);
...
$xt->assign("identificacion_fieldheadercolumn",true);
$xt->assign("identificacion_fieldheader",true);
$xt->assign("identificacion_fieldcolumn",true);
$xt->assign("identificacion_fieldfootercolumn",true);
