...
$layout->blocks["top"][] = "search";$page_layouts["tipo_docente_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "tipo_docente_search.htm";
...
$params['shortTableName'] = 'tipo_docente';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if(GetLookupTable("descripcion", $strTableName))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][GetLookupTable("descripcion", $strTableName)] = GetTableURL(GetLookupTable("descripcion", $strTableName));
