...
add_nocache_headers();
include_once("include/justificados_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["justificados_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "justificados_inline_add.htm";
else
	$templatefile = "justificados_add.htm";
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if(GetTableData($strTableName,".edit",false) && $permis['edit'])
						$message .='&nbsp;<a href=\'justificados_edit.php?'.$keylink.'\'>'."Editar".'</a>&nbsp;';
					if(GetTableData($strTableName,".view",false) && $permis['search'])
						$message .='&nbsp;<a href=\'justificados_view.php?'.$keylink.'\'>'."Ver".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: justificados_".$pageObject->getPageType().".php");
