...
$layout = new TLayout("login","PurificOrange","MobileOrange");
...
//  username and password are stored in the database
	...
	$strSQL = "select * from ".AddTableWrappers("usuarios")." where ".AddFieldWrappers($cUserNameField).
...
if(@$_GET["message"]=="expired")
	$message = "Su sesión ha expirado, Por favor ingrese otra vez";
