...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"alumno","varname"=>"alumno");
	  $this->lstTables[]=array("name"=>"docentes","varname"=>"docentes");
	  $this->lstTables[]=array("name"=>"ausentes","varname"=>"ausentes");
	  $this->lstTables[]=array("name"=>"tipo_docente","varname"=>"tipo_docente");
	  $this->lstTables[]=array("name"=>"justificados","varname"=>"justificados");
	  $this->lstTables[]=array("name"=>"usuarios","varname"=>"usuarios");
	}
