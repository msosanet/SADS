				...
				<tr>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						<tr>
							...
							<td width="190" bgcolor="#EAEAEA" align="right">
							E-mail:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="text" name="mail" size="30" maxlength="30" value="<?echo $_POST['mail'];?>" /></td>
							</td>
...
if ($yaesta == 0)
{
	...
	if (mysql_query ("INSERT INTO docentes VALUES ('$dni','$apellido','$nombre','$calle','$telefono','$tipo','$numero','$sexo','$piso','$depto','$barrio','$celular','$mail')"))
	{		
