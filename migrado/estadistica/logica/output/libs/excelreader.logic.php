...
* @version    CVS: $Id: excelreader.php,v 1.1 2008/06/10 10:57:23 Administrator Exp $
...
class Spreadsheet_Excel_Reader
{
    ...
    /**
     * Date format which used for function locale2db in file import.php, func insertRecord
     *
     * @var string
     */
    var $dateLocaleFormat = "Y-m-d H:i:s";
	
	var $timeLocaleFormat = "H:i:s";
    ...
    function Spreadsheet_Excel_Reader()
    {
		...
		{
			$this->dateLocaleFormat = "m-d-Y H:i:s";
		}
		elseif ($locale_info["LOCALE_IDATE"] == 1)
		{
			$this->dateLocaleFormat = "d-m-Y H:i:s";
		}
		elseif ($locale_info["LOCALE_IDATE"] == 2)
		{
			$this->dateLocaleFormat = "Y-m-d H:i:s";
		}
    }
...
//            $r = &$this->file->nextRecord();
    ...
    {		
        if ($numValue > 1) {
            ...
            $string = date($this->dateLocaleFormat, $utcValue);
            ...
            $string = date ($this->timeLocaleFormat, mktime($hours, $mins, $secs));
        }
