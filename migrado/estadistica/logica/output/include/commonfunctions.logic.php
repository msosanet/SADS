...
function checkTableName($shortTName, $type=false)
{
	...
	if ("ACCESOS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
	{
		return true;	
	}
	if ("alumnos_faltas_Chart" == $shortTName && ($type===false || ($type!==false && $type == 3)))
	{
		return true;	
	}
	if ("alumnos_faltas_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
	{
		return true;	
	}
	return false;
...
function GetTablesList($pdfMode=false)
{
	$arr=array();
		$arr[]="ACCESOS";
		$arr[]="alumnos_faltas Chart";
		$arr[]="alumnos_faltas Report";
	return $arr;
}
...
function GetTableURL($table="")
{
	...
	if("ACCESOS"==$table) 
		return "ACCESOS";
	if("alumnos_faltas Chart"==$table) 
		return "alumnos_faltas_Chart";
	if("alumnos_faltas Report"==$table) 
		return "alumnos_faltas_Report";
}
...
{	
	if(!$shortTName)
		return false;
	if("ACCESOS"==$shortTName) 
		return "ACCESOS";
	if("alumnos_faltas_Chart"==$shortTName) 
		return "alumnos_faltas Chart";
	if("alumnos_faltas_Report"==$shortTName) 
		return "alumnos_faltas Report";
}
...
{
	if($shorttable=="alumnos_faltas_Chart")
		return "2DColumn";
	return "";
}
...
function GetUserPermissions($table="")
{
	...
	if($table=="alumnos_faltas Chart")
	{
			return "ADESPIM";
	}
	if($table=="alumnos_faltas Report")
	{
			return "ADESPIM";
	}
}
