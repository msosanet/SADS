...
<form method="GET" action="bus_titulo.php">

<?
include 'snipet_barramenu.php'; //COMPRUEBA EL TIPO DE USUARIO Y DESPLIEGA MENÚ DE FUNCIONES ACORDE
?>	
<br>
<p align="left" class="titulo">Buscar Alumno por Apellido para cargarle un titulo.</p>
<br>
...
<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
	...
	<tr bgcolor="#CCCCCC">
		...
		<td width="118" align="center"  height="36">Titulo</td>
...
?> 
	...
	<tr bgcolor="#EEEEEE">
		...
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="crear_titulo.php?dni=<? echo $fila2['dni']; ?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Legajo"></a></td>
