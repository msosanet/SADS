...
<form method="GET" action="modif_pase.php">

<?
include 'snipet_barramenu.php'; //COMPRUEBA EL TIPO DE USUARIO Y DESPLIEGA MENÚ DE FUNCIONES ACORDE
?>	
<br>
<p align="left" class="titulo">Buscar Alumno por Apellido para modificar un pase.</p>
<br>
...
if (isset($_GET['muestra2'])) { 
    ...
    $_pagi_sql = "SELECT * FROM alumno,pase WHERE (alumno.apellido like'%$descripcion%' or alumno.dni like'%$descripcion%') and pase.alumno=alumno.dni AND pase.fecha_conf != '0000-00-00'";
    $_pagi_cuantos = 20;
...
<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
	...
	<tr bgcolor="#CCCCCC">
		...
		<td width="118" align="center"  height="36">Ver pase</td>
...
?> 
	...
	<tr bgcolor="#EEEEEE">
		...
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ver_pase.php?id_pase=<? echo $fila2[id]; ?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Legajo"></a></td>
