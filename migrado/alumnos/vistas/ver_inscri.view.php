...
$resultmotivo = mysql_query ("SELECT * FROM plan order by descripcion");
...
<form method="GET" action="ver_inscri.php">
...
?>
				...
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Listar Inscripciones.</p>
						</p>
					<p align="center">&nbsp;
					...
					<table border="0" width="62%">
						...
						<tr>
							...
							<td align="right">&nbsp;    <select size="1" autofocus="true" name="plan"> <!-- ****************************LISTA MOTIVOS -->
						  <?	
                            WHILE ($myrow6 = mysql_fetch_array($resultmotivo)) {			
						    	echo "<option value='" . $myrow6[id] . "'>" . $myrow6[descripcion] . "</option>";
						    }
						  ?>
                          </select></td>
							<td align="right" rowspan="3" width="389" >
