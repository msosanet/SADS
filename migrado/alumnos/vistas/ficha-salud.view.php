...
<form method="GET" action="ficha-salud.php?actor=<? echo $actor; ?>">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Cargar Ficha de Salud del ALUMNO</p>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="8">
												...
												<tr>
							<td colspan="8" height="40" align="left" class="titulo2" bgcolor="#bbCbbb">&nbsp;Alumno: <b><?echo $filadocente['apellido'] .", " . $filadocente['nombre'] . "</b> - D.N.I. Nº " . number_format($filadocente[dni],0,'','.'); ?></td>
						</tr>
						<tr>
