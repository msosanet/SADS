...
<title>Agregar documentacion a alumnos</title>
</head>
...
<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
	...
	<tr bgcolor="#CCCCCC">
		...
		<td width="118" align="center"  height="36">Modif.</td>	
	<td width="118" align="center"  height="36">Eliminar.</td>			
	</tr>
...
?> 
	...
	<tr bgcolor="#EEEEEE">
		...
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="docu2.php?dni=<? echo $fila2[dni]; ?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar documentacion"></a></td>
				<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="docuxx.php?dni=<? echo $fila2[dni]; ?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar documentacion"></a></td>
