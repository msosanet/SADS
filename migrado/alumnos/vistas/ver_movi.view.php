...
<form method="GET" action="ver_movi.php">
...
<div align="center">
			<table border="0" width="980">
				<tr>
					<td>
					<p class="titles1" align="left">Listado de movilidad Estudiantil</p>
 
<?
$_pagi_sql="SELECT * FROM novedades where borrado=1 and movi=1 ORDER BY codigo DESC";
