...
<form method="GET" action="alumnos-listar.php">
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="200" align="center" height="36">Curso/div</td>
		...
		$ff = mysql_query ("SELECT * FROM cursa WHERE alumno = $fila2[dni] and anio='$anio' and control=1");
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $ff[curso];?>/<?echo $ff[divi];?></td>
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="cargar_nov.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar Novedad"></a></td>
