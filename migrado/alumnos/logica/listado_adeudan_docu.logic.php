<?PHP
// Devuelve "alumnos de 6to aÃ±o.xls" con tabla de alumnos de todos los 6tos que adeudan
// documentacion: DNI, partida de nacimiento, Certificado de FinalizaciÃ²n estudios Primarios
// o AnalÃ­tico parcial (TambiÃ©n usado para primer aÃ±o con otra doocumentaciÃ³n)

session_start();
include 'conexion.php';

$ext=".xls";
$nombre="alumnos de 1ro aÃ±o".$ext;
$anio=date("Y");
...
echo "<table>"; //Linea de aclaraciÃ³n de fecha y usuario que obtiene el listado
	echo "<tr>";
...
// Volcado de datos de la consulta en la tabla 
	while ($fila2 = mysql_fetch_array($result)) {
		...
		$ade_ap=mysql_query("SELECT * FROM docu_alu WHERE alumno=$fila2[dni] AND id=11"); //consulta AnalÃ­tico
