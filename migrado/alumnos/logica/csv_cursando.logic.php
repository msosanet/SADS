...
// Nombre y apellido de quiÃ©n obtuvo el listado. Fecha de obtenido
	echo "Listado de estudiantes cursando desde el " . date("j/n/Y",strtotime($desde)) . " y al día " . date("j/n/Y",strtotime($hasta)) . " obtenido el " . date("j/n/Y") . " por " . $fila['nombre'] . " " . $fila['apellido'] . "\n";
