...
<form method="GET" action="cv2.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Consultar Horario por Apellido.</p>
						</p>
					<p align="center">&nbsp;
					</p>
					<div align="left">
...
{ 
	...
	$_pagi_sql="SELECT * FROM docentes WHERE apellido like'%$descripcion%' and identificacion=2 order by apellido";
...
<br><br>
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ver_hs.php?actor=<?php echo $fila2[dni]?>&fdesde=<?php echo $_GET["fecha_desde"]?>&fhasta=<?php echo $_GET["fecha_hasta"]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Horario"></a></td>
