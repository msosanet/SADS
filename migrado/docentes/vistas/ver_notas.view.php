...
{ 
	...
	$_pagi_sql="SELECT * FROM notas WHERE descripcion like '%$descripcion%'";
...
<br><br>
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="modif_nota.php?nota=<?php echo $fila2[codigo]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Modificar Nota"></a></td>
