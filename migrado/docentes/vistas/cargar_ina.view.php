...
$r2 = mysql_query ("SELECT * FROM materia_docente, materia where materia_docente.fecha_baja='0000-00-00' and materia_docente.docente='$dni' and materia_docente.materia=materia.codigo order by materia_docente.caracter, materia_docente.fecha_alta");


$resultmotivo = mysql_query ("SELECT * FROM licencia order by codigo"); 
...
<form method="POST" action="cargar_ina.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Cargar Licencias</p>
...
if (mysql_query ("INSERT INTO ausentes VALUES (0,'$dni','$fecha_desde','$fecha_desde','$hora','$motivo','$graba','$observaciones','$now',$identificacion,0,$nomostrar)"))
	{		
				...
				<meta http-equiv='refresh' content='0; URL=cargar_ina.php?dni=<?php echo $dni ?>'>
				<? 
				}					
$cantdias=$cantdias-1;
