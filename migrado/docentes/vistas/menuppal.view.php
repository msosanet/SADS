...
<li><a href="menu.php" id="current">Notas</a>
				<ul>
					...
					<li><a href="ver_notas.php">Consultar Notas.</a></li>
		   </ul>
		...
		<li><a href="menu.php" id="current">Justif.</a>
				<ul>
					...
					<li><a href="planilla.php">Generar planilla inasis.</a></li>
					<li><a href="faltas.php">Generar planilla hs Doc.</a></li>
					<li><a href="faltas3.php">Generar planilla hs NO Doc.</a></li>
...
<li><a href="menu.php" id="current">Mesas</a>
				<ul>
					<li><a href="mesas.php">Crear</a></li>
					<li><a href="veo_mesas.php">Buscar/Imprimir</a></li>
					<li><a href="mesas4.php" target="_blank">Listar alumnos</a></li>
					<li><a href="mesas5.php" target="_blank">Listar Materias</a></li>
					<li><a href="mesas6.php" target="_blank">Listar Todos</a></li>
					<li><a href="mesas7.php" target="_self">Listar x Profe</a></li>
