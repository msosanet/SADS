...
<form method="POST" action="add_caracter.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Cargar Caracter</p>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						?>
							<td width="174" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Descripción del Caracter:</td>
...
$resultdocente = mysql_query ("SELECT * FROM caracter where descripcion='$desc'");
$yaesta = mysql_num_rows($resultdocente); 

if ($yaesta == 0)
{

	if (mysql_query ("INSERT INTO caracter VALUES (0,'$desc')"))
	{		
...
?>
				<script>
				var answer=alert("Ese caracter ya se encuentra cargado")
				</script> 
				<meta http-equiv='refresh' content='0; URL=menu.php?'>
				<? 
