...
/*	$strWhereClause = $pageObject->searchClauseObj->getWhere(GetListOfFieldsByExprType(false,$pageObject->tName));
	...
	$strSQL = gSQLWhere_having($gsqlHead, $gsqlFrom, $gsqlWhereExpr, $sqlGroupBy, $sqlHaving, $strWhereClause, $strHavingClause);
...
else
{
	...
	$rb = new Report(array($gsqlHead, $gsqlFrom, $gsqlWhereExpr, $sqlGroupBy, $sqlHaving), $g_orderindexes, $pageObject->searchClauseObj, $conn, $PageSize, 30, $params);
