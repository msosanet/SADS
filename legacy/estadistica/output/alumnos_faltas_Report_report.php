...
$layout = new TLayout("report5","FusionGreen","MobileGreen");
...
$layout->blocks["top"][] = "search";$page_layouts["alumnos_faltas_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="alumnos_faltas_Report_report.php"
	</script>
	<?php
	}
	else
...
$params = array("id" => $id,
				...
				"arrRecsPerPage" => GetTableData($strTableName,".arrRecsPerPage",array()),
				"arrGroupsPerPage" => GetTableData($strTableName,".arrGroupsPerPage",array()),
				"reportGroupFields" => GetTableData($strTableName,".reportGroupFields",false));
$params["xt"] = &$xt;
...
if($eventObj->exists("BeforeProcessReport"))
	$eventObj->BeforeProcessReport($conn);
...
$params['shortTName'] = "alumnos_faltas_Report";
...
$fieldArr = array();
$fieldArr['name'] = "fecha";
$fieldArr['label'] = "Fecha";
$fieldArr['goodName'] = "fecha";
$fieldArr['repPage'] = "1";
...
$fieldArr = array();
$fieldArr['name'] = "total";
$fieldArr['label'] = "Total";
$fieldArr['goodName'] = "total";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
...
/*	$strWhereClause = $pageObject->searchClauseObj->getWhere(GetListOfFieldsByExprType(false,$pageObject->tName));
	...
	$gsqlWhereExpr=AddWhere($gsqlWhereExpr,$strWhereClause);
	
	$strSQL=$gsqlHead." ".$gsqlFrom." ".$gsqlWhereExpr." ".$sqlGroupBy." ".$sqlHaving;	*/		
	
	
	
	$strWhereClause = $pageObject->searchClauseObj->getWhere(GetListOfFieldsByExprType(false,$pageObject->tName));
	$strHavingClause = $pageObject->searchClauseObj->getWhere(GetListOfFieldsByExprType(true,$pageObject->tName));
	...
	$strSQL = gSQLWhere_having($gsqlHead, $gsqlFrom, $gsqlWhereExpr, $sqlGroupBy, $sqlHaving, $strWhereClause, $strHavingClause, $strSearchCriteria);
	

	$cross_array=array("tables"=>$cross_array["tables"],"group_fields"=>$cross_array["group_fields"],"totals"=>$cross_array["totals"],"table_type"=>"project");
...
{
	$rb = new Report(array($gsqlHead, $gsqlFrom, $gsqlWhereExpr, $sqlGroupBy, $sqlHaving), $g_orderindexes, $pageObject->searchClauseObj, $conn, $_SESSION[$sessionPrefix."_pagesize"], -1, $params);
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='alumnos_faltas_Report_search.php';return false;\"");
...
if($eventObj->exists("BeforeShowReport"))
	$eventObj->BeforeShowReport($xt, $pageObject->templatefile);
