...
$layout->blocks["top"][] = "export";$page_layouts["justificados_export"] = $layout;
...
$xt->display("justificados_export.htm");

function ExportToExcel_old()
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=justificados.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=justificados.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=justificados.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=justificados.csv");
