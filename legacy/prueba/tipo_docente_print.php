...
$layout->blocks["top"][] = "pdf";$page_layouts["tipo_docente_print"] = $layout;
...
$arr['viewFormat'] = ViewFormat("descripcion", $strTableName);
$fieldsArr[] = $arr;
...
//	descripcion - 
			$value="";
				$value = ProcessLargeText(GetData($data,"descripcion", ""),"field=descripcion".$keylink,"",MODE_PRINT);
			$record["descripcion_value"]=$value;
			if($col<$colsonpage)
...
$xt->assign("descripcion_fieldheadercolumn",true);
$xt->assign("descripcion_fieldheader",true);
$xt->assign("descripcion_fieldcolumn",true);
$xt->assign("descripcion_fieldfootercolumn",true);
