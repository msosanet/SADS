...
$layout->blocks["top"][] = "details";$page_layouts["justificados_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "justificados_inline_edit.htm" : "justificados_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: justificados_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_justificados->Copy();
...
if(!$data)
{
	...
	{
		header("Location: justificados_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='justificados_view.php?".$viewlink."'\"");
