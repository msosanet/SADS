...
$layout->blocks["top"][] = "details";$page_layouts["ausentes_view"] = $layout;
...
//notifico - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"notifico", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="notifico")
		$ownerIdValue=$value;
	$xt->assign("notifico_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='ausentes_edit.php?".$editlink."'\"");
