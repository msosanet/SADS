...
include("include/ausentes_settings.php");
include("include/justificados_settings.php");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["docentes_list"] = $layout;
