...
$layout = new TLayout("print","PurificOrange","MobileOrange");
...
$layout->blocks["top"][] = "pdf";$page_layouts["ausentes_print"] = $layout;
...
$arr = array();
$arr['fName'] = "notifico";
$arr['viewFormat'] = ViewFormat("notifico", $strTableName);
$fieldsArr[] = $arr;
...
//	include proper masterprint.php code
	include("include/docentes_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"ausentes","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_docentes";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["docentes_masterprint"] = $layout;
	...
	$layout = GetPageLayout("docentes", 'masterprint');
	if($layout)
	{
...
$xt->assign("docente_fieldheadercolumn",true);
$xt->assign("docente_fieldheader",true);
$xt->assign("docente_fieldcolumn",true);
$xt->assign("docente_fieldfootercolumn",true);
$xt->assign("fecha_desde_fieldheadercolumn",true);
$xt->assign("fecha_desde_fieldheader",true);
$xt->assign("fecha_desde_fieldcolumn",true);
$xt->assign("fecha_desde_fieldfootercolumn",true);
$xt->assign("fecha_hasta_fieldheadercolumn",true);
$xt->assign("fecha_hasta_fieldheader",true);
$xt->assign("fecha_hasta_fieldcolumn",true);
$xt->assign("fecha_hasta_fieldfootercolumn",true);
...
$xt->assign("notifico_fieldheadercolumn",true);
$xt->assign("notifico_fieldheader",true);
$xt->assign("notifico_fieldcolumn",true);
$xt->assign("notifico_fieldfootercolumn",true);
