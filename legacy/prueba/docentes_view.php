...
$layout->blocks["top"][] = "details";$page_layouts["docentes_view"] = $layout;
...
$arr = array();
$arr['fName'] = "dni";
$arr['viewFormat'] = ViewFormat("dni", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "apellido";
$arr['viewFormat'] = ViewFormat("apellido", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "nombre";
$arr['viewFormat'] = ViewFormat("nombre", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "identificacion";
$arr['viewFormat'] = ViewFormat("identificacion", $strTableName);
$fieldsArr[] = $arr;
...
//dni - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"dni", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="dni")
		$ownerIdValue=$value;
	$xt->assign("dni_value",$value);
...
//apellido - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"apellido", ""),"","",MODE_VIEW);
...
//nombre - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"nombre", ""),"","",MODE_VIEW);
...
//identificacion - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"identificacion", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="identificacion")
		$ownerIdValue=$value;
	$xt->assign("identificacion_value",$value);
...
/*$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("dni")."': '".(jsreplace(@$data["dni"]))."', ";
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='docentes_edit.php?".$editlink."'\"");
