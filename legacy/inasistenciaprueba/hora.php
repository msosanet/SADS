...
{ 
	...
	$resu = mysql_query ("SELECT * FROM diario_reloj, docentes WHERE docentes.identificacion= 2 and diario_reloj.dni = docentes.dni and fecha ='$fecha' and horario >= '$hora' order by docentes.apellido, docentes.nombre, diario_reloj.horario");
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						<tr>
							...
							&nbsp;Resultado de la PC  <font color="#D08230"><?echo $fecha_invert1?></td>
						</tr>
						<tr>
							<td width="300" bgcolor="#ffffff" align="center" height="36"><b>Apellido y Nombre</td></b>
							<td bgcolor="#ffffff" width="80" align="center"  height="36"><b>Horario de Entrada</td></b>
							<td bgcolor="#ffffff" width="80" align="center" height="36"><b>Entrada Real</td></b>
							<td bgcolor="#ffffff" width="80" align="center"  height="36"><b>Horario de Salida</td></b>
							<td bgcolor="#ffffff" width="80" align="center" height="36"><b>Salida Real</td></b>
						</tr>

		<?php while ($fila2 = mysql_fetch_array($_pagi_result))
		{	
			$resultobs = mysql_query ("SELECT * FROM diario WHERE dni = '$fila2[dni]' and tipo='Salida' and fecha='$fecha'");
		...
		?> 
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila5[hs_salida];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $filaobs[horario];?></td>
						</tr>
		<?
		}
		?>
...
<table border="1" width="900" id="table2" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						<tr>
							<td class="text1b"background="../imag/bar07.gif"  colspan="3" height="40" align="left">
							&nbsp;Resultado de la huella digital <font color="#D08230"><?echo $fecha_invert1?></td>
						</tr>
						<tr>
							<td width="300" bgcolor="#ffffff" align="center" height="36"><b>Apellido y Nombre</td></b>
							<td bgcolor="#ffffff" width="80" align="center"  height="36"><b>Horario</td></b>
							<td bgcolor="#ffffff" width="80" align="center" height="36"><b>Tipo</td></b>
						</tr>

		<?php while ($fila3 = mysql_fetch_array($resu))
		{	
			//$resultdoc = mysql_query ("SELECT * FROM docentes WHERE dni = '$fila3[dni]'");
			//$filadoc = mysql_fetch_array($resultdoc);

		?> 
						<tr>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila3[apellido];?>,<?echo $fila3[nombre];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila3[horario];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila3[tipo];?></td>
