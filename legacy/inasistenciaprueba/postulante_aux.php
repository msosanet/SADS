...
<form method="POST" action="postulante_aux.php?nota=<? echo $nota?>&id=<? echo $id?>"></p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Ofrecimiento N�: <? echo $filatt2['numero'];?></p>
		<?php while ($filatt = mysql_fetch_array($resulta))
		{ ?>
					<p align="left" >Espacio: <? echo $filatt2['descripcion'];?>&nbsp;&nbsp;&nbsp;Horario: <? echo $filatt['hs_cubrir'];?>   Curso:<? echo $filatt['curso'];?>/<? echo $filatt['divi'];?></p> <? } ?>

		<br><br><?php while ($filabb = mysql_fetch_array($postu))
		{ $inc=$inc+1; ?>
					<p align="left" ><b><? echo $inc;?>) Postulante: <? echo $filabb['apellido'];?>&nbsp;<? echo $filabb['nombre'];?>&nbsp;&nbsp;Puntaje: <? echo $filabb['letra'];?> / <? echo $filabb['puntaje'];?> <a href="mod_puntaje.php?actor=<?php echo $filabb[id]?>&codigo=<?php echo $filabb[codigo]?>" target="_self"></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;editar</a><a href="alta_docente_info.php?nota=<?php echo $filabb[id]?>" target="_self"></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ingreso</a></p> <? } ?>
<div align="left">
...
$nombre=addslashes($nombre);
	...
	{		
				...
				<meta http-equiv='refresh' content='0; URL=postulante_aux.php?nota=<?php echo $nota?>&id=<?php echo $id?>'>
				<? 			
	}
	else {	
				?>
