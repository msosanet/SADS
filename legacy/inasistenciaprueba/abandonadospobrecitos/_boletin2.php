...
$sql = "SELECT DISTINCT division FROM alumnos_curso ORDER BY division ASC";
$result = mysql_query($sql);
...
$alumnos = mysql_query("SELECT DISTINCT * FROM alumnos WHERE curso='$curso' AND division='$division' ORDER BY alumno ASC") or die(mysql_error());
...
{ $flag=0;
  ...
  $dia=date("w",mktime(0,0,0,$mess,$z,$year));
				...
				if ($feri>'0') //SI HAY ALGUN REGISTRO ES FERIADO
				{ $flag=1;
