				...
				<tr>
					...
					<table border="0" width="895" id="table1" cellpadding="2" cellspacing="4">
						...
						<tr>
							...
							<td bgcolor="#EAEAEA" width="265" align="left">DD-MM-AAAA: <input type="text" name="f_nac" size="10" maxlength="10" value="<?echo $filatt['f_nac'];?>" /></td>
						...
						<tr>
							...
							<td width="190" bgcolor="#EAEAEA" align="left"><input type="text" name="tribu" size="30" maxlength="30" value="<?echo $filatt['tribu'];?>" />
...
$result77 = mysql_query ("SELECT * FROM movimientos WHERE dni = '$dnipuntos' order by baja",$db2);
?>
<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
		...
		{ 
				if ($fila77[baja]=="0000-00-00") { ?> <tr bgcolor="#DDCCCC"> <?} else {?> <tr bgcolor="#ffffff"> <? } ?>
...
<b>CANTIDAD DE HS: <? echo $sumahs;?> se debe controlar las hs en todos los casos</b>
...
if (mysql_query ("UPDATE docentes SET nombre='$nombre',apellido='$apellido',direccion='$direccion',mail='$mail',sexo='$sexo',identificacion=$tipo,telefono='$telefono',piso='$piso',depto='$depto',numero=$numero,barrio='$barrio', celular='$celular', idreloj='$reloj', cargo=$cargo, f_nac='$fnac', tribu='$tribu' where dni='$actor'"))
{	
				?>
				<script>
