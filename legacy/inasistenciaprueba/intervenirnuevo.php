...
?>	
				...
				<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="200" align="center" height="36">Cantidad de Intervenciones</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Ver Derivaciones</td>
						</tr>
				...
				<?php while ($fila2 = mysql_fetch_array($_pagi_result))
					...
					?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[Cantidad];?></td>
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="intervenir.php?descripcion=<?php echo $fila2[alumno];?>&muestra2=+++Buscar+++" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Derivar"></a></td>
