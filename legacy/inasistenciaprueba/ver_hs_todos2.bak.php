...
<form method="GET" action="ver_hs_todos2.php?actor=<?php echo $actor?>">
...
?>
				...
				<tr>
					...
					<p align="center">&nbsp;</p>
					<p align="left">
					<p align="center"><b>ARCHIVOS ASOCIADOS</p></b><br>
...
<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						<tr>
							...
							<center>Horario Declarado por &nbsp;<? echo $filatt[apellido] . ", " . $filatt[nombre]; ?>
							</td>
						</tr>
						<tr>
						<td align="center" width="100" bgcolor="#EEEEEE">
		...
		<?php while ($fila77 = mysql_fetch_array($result77))  {
            if ($fila77[cod_dia] ==1) {
                $horas_lunes = substr($fila77[hs_entrada], 0, 5) . " a " . substr($fila77[hs_salida], 0, 5); }
            if ($fila77[cod_dia] ==2) {
                $horas_martes = substr($fila77[hs_entrada], 0, 5) . " a " . substr($fila77[hs_salida], 0, 5); }
            if ($fila77[cod_dia] ==3) {
                $horas_miercoles = substr($fila77[hs_entrada], 0, 5) . " a " . substr($fila77[hs_salida], 0, 5); }
            if ($fila77[cod_dia] ==4) {
                $horas_jueves = substr($fila77[hs_entrada], 0, 5) . " a " . substr($fila77[hs_salida], 0, 5); }
            if ($fila77[cod_dia] ==5) {
                $horas_viernes = substr($fila77[hs_entrada], 0, 5) . " a " . substr($fila77[hs_salida], 0, 5); }
         }
         ?>
                    <tr>
                        <td align="center"> <? echo $horas_lunes; ?></td>
                        <td align="center"> <? echo $horas_martes; ?></td>
                        <td align="center"> <? echo $horas_miercoles; ?></td>
                        <td align="center"> <? echo $horas_jueves; ?></td>
                        <td align="center"> <? echo $horas_viernes; ?></td>
                    </tr>
