...
?><BR><BR><BR>
				<tr>
					...
					<div align="center">
<? if ($_SESSION['valor']==3 or $_SESSION['valor']==4)
{
...
if ($_SESSION['valor']==0 or $_SESSION['valor']==1 or $_SESSION['valor']==2)
{
	...
	$_pagi_sql="SELECT docentes.dni,apellido,nombre, motivo, descripcion,fecha_desde,observaciones, count( motivo ) AS cantidad FROM ausentes, motivos, docentes WHERE ausentes.fecha_desde >= '$fecha_hoy' AND ausentes.identificacion = 1 AND ausentes.motivo = motivos.codigo AND ausentes.docente = docentes.dni and (ausentes.motivo=29 or ausentes.motivo=20 or ausentes.motivo=1 or ausentes.motivo=2 or ausentes.motivo=4 or ausentes.motivo=8 or ausentes.motivo=9 or ausentes.motivo=24 or ausentes.motivo=6 or ausentes.motivo=7 or ausentes.motivo=42 or ausentes.motivo=44 or ausentes.motivo=15 or ausentes.motivo=3 or ausentes.motivo=56 or ausentes.motivo=67) GROUP BY dni,motivo ORDER BY apellido";
...
<table border="1" width="980" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							<td width="150" bgcolor="#808080" align="center" height="36">Docente</td>
...
?>
						<tr>
							...
							<td width="20" align="center"><?echo $fila2[observaciones];?></td>
