...
<title>CARGA INASIS JUSTIF</title>
...
<body>
<div id="marco980"><!-- ******************************* INICIA DIVISION PRINCIPAL ************************ -->
...
<table border="0" width="100%">
    <tr align="right">
        <td class="titulo" align="left">Cargar Inasistencias Justificadas</td>
        <td>                                                                     
            <form method="GET" action="sube2.php?actor=<? echo $dni; ?>" name="form20">
<!-- ************** LISTA DE DOCENTES PARA ELEGIR *********************************** -->                    
            ...
            <? $listadocentes = mysql_query ("SELECT * FROM docentes WHERE identificacion = 1 ORDER BY apellido,nombre");
            	...
            	while ($docente = mysql_fetch_array($listadocentes)) {			
					echo "<option value='" . $docente[dni] . "'>" . $docente[apellido] . " " . $docente[nombre] . " - D.N.I. N� " . $docente[dni] . "</option>";
				    }
		    ?>
            </select>
...
<p align="center" class="text1b"><? if($hayerrores) { echo "<h4><font color=red>Existen errores en el ingreso de datos, est&aacute;n marcado con color ROJO</font></h4>";} ?>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						<tr>
							<td class="titulo2" colspan="4" height="40" align="left" bgcolor="#Cbbbbb">&nbsp;Docente: <b><? echo $filadocente['apellido'] . ',&nbsp;' . $filadocente['nombre'] . '</b> - D.N.I. N� ' . number_format ( $filadocente['dni'], 0, ',', '.' );?>
       </td>
		</tr>
		...
		<tr>
			...
			<select size="1" name="motivo" autofocus>
			<?	
		...
		?>
			...
			<td width="74" bgcolor="#EAEAEA" align="right"><font color="<? echo $color; ?>">Fecha Desde: </font></td>
		...
		?>
			...
			<td width="74" bgcolor="#EAEAEA" align="right"><font color="<? echo $color; ?>">Fecha Hasta: </font></td>
			<td bgcolor="#EAEAEA" width="425" align="left">
...
if (mysql_query ("INSERT INTO ausentes VALUES (0,'$dni','$fecha_desde','$fecha_desde','$hora','$motivo','$graba','$observaciones','$now',1,1,$nomostrar,$nopizarra,0)"))
	{		
...
$cantdias=$cantdias-1;
      ...
      $fecha_desde= date("Y-m-d", $calculo);		
				...
				<meta http-equiv='refresh' content='0; URL=sube2.php?actor=<?php echo $dni ?>&ident=1'>
				<? 
