...
?>
				<tr>
					...
					<br><br>
					<p align="center" class="text1b"><? if($hayerrores) { echo "<h4><font color=red>Existen errores en el ingreso de datos, est�n marcado con color ROJO</font></h4>";} ?>
</p><div align="left">
		...
		<tr>
			...
			<table border="0" width="780" id="table5" cellspacing="0" cellpadding="0">
				<tr>
					...
					Formulario F10 N� <? echo $form ?>/2010</b></td>
				</tr>
			</table>
			...
			<div align="center">
				<table border="1" width="780" id="table8" cellspacing="1" bordercolor="#E9E9E9">
					...
					<tr>
						...
						<p style="margin-top: 0; margin-bottom: 0"><b>Tarea en el �rea</b></td>
