...
<form method="GET" action="ver_inax.php">
...
{ 
	...
	$_pagi_sql="SELECT * FROM docentes WHERE apellido like'%$descripcion%' or dni like'%$descripcion%' and identificacion = '1'";
...
<br><br>
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ver_inaxxx.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar Inasistencia"></a></td>
