...
$resu = mysql_query ("SELECT * FROM diario WHERE dni = '$actor' and fecha >='$fecha' and fecha <= '$fecha2' order by fecha" );
...
<br><br>
		...
		<?php 
			while ($fila = mysql_fetch_array($resu))
					...
					<tr>
						<td align="center" width="82">
						<p style="margin-top: 0; margin-bottom: 0"><?php echo $fechas?></td>
