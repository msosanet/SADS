...
//echo "$fecha";
echo "<form method='GET' action='alumnostardet2.php?fecha=$fecha'>";
...
//$dni=$_GET['dni'];
//echo $dni;
$sql1 = "SELECT ac.dni,CONCAT(ac.apellido, ' ', ac.nombre) as alumno,c.curso,c.divi,af.tipo,af.injus,af.justificado FROM alumno ac,alumnos_faltas2 af, cursa c WHERE ac.dni=af.dni AND ac.dni=c.alumno AND c.control='1' AND c.anio='$ano' AND af.fecha='$fecha' ORDER BY alumno,c.curso,c.divi";
//echo $sqll;
...
for($i=0; $i<=$max_num_paginas;$i++){
         echo "<a href='alumnostardet2.php?fecha=".$fecha."'></a>";
      }      
...
<meta http-equiv='refresh' content='5'; URL='alumnostardet2.php?fecha=<?php echo $fec?>'>
