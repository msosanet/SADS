...
<form method="POST" action="add_tipo_nota.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Cargar tipos de Notas de Entrada</p>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						?>
							<td width="174" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Descripci�n del Tipo:</td>
...
$resultdocente = mysql_query ("SELECT * FROM tipoentrada where descripcion='$desc'");
$yaesta = mysql_num_rows($resultdocente); 

if ($yaesta == 0)
{

	if (mysql_query ("INSERT INTO tipoentrada VALUES (0,'$desc')"))
	{		
...
?>
				<script>
				var answer=alert("Ese tipo ya se encuentra cargado")
				</script> 
				<meta http-equiv='refresh' content='0; URL=menu.php?'>
				<? 
