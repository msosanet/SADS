...
<form method="GET" action="derivacion.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Consultar alumnos por nombre y apellido para derivar.</p>
						</p>
					<p align="center">&nbsp;
...
{ 
	...
	$_pagi_sql="SELECT * FROM alumnos WHERE alumno like'%$descripcion%'";
...
<br><br>
		...
		?> <table border="1" width="980" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="200" align="center" height="36">Telefono</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Padre</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Madre</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Tutor</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Direccion</td>
							<td bgcolor="#808080" width="118" align="center"  height="36">Derivar</td>							
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="derivacion2.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Derivar"></a></td>
