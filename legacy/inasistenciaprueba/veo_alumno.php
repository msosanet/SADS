...
<form method="GET" action="veo_alumno.php">
...
?>
				...
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Buscar Alumnos por apellido.</p>
						</p>
					<p align="center">&nbsp;
...
$_pagi_sql="SELECT * FROM alumno WHERE apellido LIKE '%$alumno%' OR  dni LIKE '%$alumno%' order by apellido";
...
$cont=0;		?> <table border="1" width="980" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
		...
		$rtt2 = mysql_query ("SELECT * FROM alu_fami WHERE alumno = $fila2[dni] and tipo='P'");
		$rt2 = mysql_fetch_array($rtt2) ;

		$rt3 = mysql_query ("SELECT * FROM alu_fami WHERE alumno = $fila2[dni] and tipo='M'");
		$rt3 = mysql_fetch_array($rt3) ;

		$rt4 = mysql_query ("SELECT * FROM alu_fami WHERE alumno = $fila2[dni] and tipo='T'");
		...
		$rtt6 = mysql_query ("SELECT * FROM cursa WHERE alumno = $fila2[dni] and control=1");
		$curso = mysql_fetch_array($rtt6) ;
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><a href='alumnopreceptor.php?dni=<? echo $fila2[dni]; ?>'><?echo $fila2[dni];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><a href='alumnopreceptor.php?dni=<? echo $fila2[dni]; ?>'><?echo $fila2[apellido];?>, <?echo $fila2[nombre];?></td>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $tutor[apellido];?>, <?echo $tutor[apellido];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[f_nac];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[tel];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[domicilio];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[mail];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $curso[curso];?>° <?echo $curso[divi];?>°</td>
							<td width="20" bgcolor="#EAEAEA" align="center"><a href='alumnov.php?dni=<? echo $fila2[dni]; ?>'>Modificar</a></td>
