...
<form method="GET" action="modif_parte2.php?actor=<?php echo $dni?>">
...
?>
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Listado del parte a borrar de &nbsp;<?echo $filadocente['apellido'];?>&nbsp;<?echo $filadocente['nombre'];?></p>
						</p>
					<p align="center">&nbsp;
...
?>
 ...
 <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						<tr>
							...
							&nbsp; Seleccione lo que quiere Borrar</td>
						</tr>
						<tr>
...
foreach ($_GET["afectado"] as $afectado)
	{
		if (mysql_query ("DELETE from partediario where codigo=$afectado"))
		{	
				...
				?>
				<script>
				var answer=alert("Borrado Correctamente")
				</script> 
