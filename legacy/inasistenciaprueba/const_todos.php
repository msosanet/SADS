...
<form method="GET" action="const_todos.php">
				...
				<tr>
					...
					<table border="0" width="100%">
						...
						<tr>
							...
							<td width="150" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Tipo de constancia:</td>
							</font>
...
{ 
	...
	$_pagi_sql="SELECT distinct docentes.dni FROM diario, docentes WHERE fecha ='$fecha_desde' and diario.dni=docentes.dni order by docentes.apellido";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="80" align="center" height="36">DNI</td>
...
while ($fila2 = mysql_fetch_array($_pagi_result))
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $filaobs[dni];?></td>
...
<?}?>
<?if ($_GET[tipo]=="mesas"){?>
							<td width="20" bgcolor="#EAEAEA" align="center"><a href="pdf_const2.php?dni=<?php echo $fila2[dni]?>&fecha=<?php echo $fecha_desde ?>&hse=<?php echo $hora_entrada ?>&hss=<?php echo $hora_salida ?>" target="_blank">Constancia</a></td>
<?}?>								
