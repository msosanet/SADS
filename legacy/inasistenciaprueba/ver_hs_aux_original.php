...
<form method="GET" action="ver_hs_aux.php?actor=<?php echo $actor?>">
...
?>
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Filtro por Fecha de:&nbsp;<font color="ff0000"><?echo $filatt[apellido] ?>,&nbsp;<?echo $filatt[nombre] ?></font>
 </p>
						</p>
					<p align="center">&nbsp;
...
{ 
	...
	$_pagi_sql="SELECT * FROM diario WHERE fecha >='$fecha_desde'  and fecha <= '$fecha_hasta' and dni='$actor' and tipo = 'Entrada' order by fecha";
		...
		?> 
				<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						<tr>
							...
							&nbsp;Resultado del Filtro del <font color="#D08230"><?echo $fecha_invert1?>&nbsp;hasta el&nbsp;<?echo $fecha_invert2?>--&nbsp;Docente:&nbsp;<?echo $filatt[apellido] ?>,&nbsp;<?echo $filatt[nombre] ?></font></td>
						</tr>
						<tr>
						...
						<p style="margin-top: 0; margin-bottom: 0"><b>Entrada</b></td>
						<td align="center" width="178" bgcolor="#EEEEEE">
						<p style="margin-top: 0; margin-bottom: 0"><b>Salida</b></td>

					</tr>

		<?php 
			$result6 = mysql_query ("SELECT * FROM diario WHERE (dni = '$actor') and (tipo='Salida') and (fecha ='$fecha_desde') ");
while ($fila2 = mysql_fetch_array($_pagi_result))
		...
		?> 
					<tr>
						<td align="center" width="82">
						<p style="margin-top: 0; margin-bottom: 0"><?php echo $fila2[fecha]?></td>
						<td align="center" width="87">
						<p style="margin-top: 0; margin-bottom: 0"><?php echo $fila2[horario]?></td>
						<td align="center" width="178">
						<p style="margin-top: 0; margin-bottom: 0"><?php echo $fila6[horario]?></td>
					</tr>
						<?
						}
						?>
