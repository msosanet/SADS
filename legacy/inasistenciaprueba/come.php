...
<form method="GET" action="come.php">
...
?>
				...
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Buscar alumno por Apellido para agregarlo al comedor.</p>
						</p>
					<p align="center">&nbsp;
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="118" align="center"  height="36">Agregar al comedor</td>							
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="come_add.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar Inasistencia"></a></td>
