...
<form method="GET" action="cv_todos.php">
...
{ 
	...
	$_pagi_sql="SELECT * FROM alumnos_curso WHERE alumno like'%$descripcion%'";
...
<br><br>
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ver_faltas_actor.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Faltas"></a></td>
