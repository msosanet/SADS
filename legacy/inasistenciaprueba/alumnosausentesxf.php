...
$sql="SELECT ac.dni,CONCAT(ac.apellido, ' ', ac.nombre) as alumno,c.curso,c.divi as division,af.tipo FROM alumno ac,alumnos_faltas af,cursa c WHERE c.control='1' AND c.anio='$ano' AND c.alumno=ac.dni AND ac.dni=af.dni AND af.fecha='$fecha' ORDER BY c.curso,c.divi, alumno";
//echo $sql;
