...
<form method="GET" action="pedido1.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Generar planilla de Inasistencias por docente</p>
						</p>
					<p align="center">&nbsp;
					</p>
					<div align="left">
						...
						<tr>	
							<td width="350" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Ingrese el Apellido o parte de el:</td>
							</font>
    
							<td bgcolor="#EAEAEA" width="225" align="left">
 							<input type="text" name="descripcion" id="descripcion" size="28" maxlength="40" value="" />
							</td>
				
						       <td width="150" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>"></td>
							</font>
...
{ 
	...
	$_SESSION['desde']=$_GET['fecha_desde'];
	$_SESSION['hasta']=$_GET['fecha_hasta'];


	$descripcion=$_GET['descripcion'];

	$_pagi_sql="SELECT * FROM docentes WHERE apellido like'%$descripcion%' order by apellido";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="200" align="center" height="36">Funcion</td>
		...
		$result4 = mysql_query ("SELECT curso.descripcion FROM curso, horarios WHERE horarios.dni = '$fila2[dni]' and curso.codigo=horarios.cod_curso");
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila4[descripcion];?></td>
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="pedido2.php?actor=<?php echo $fila2[dni]?>&fdesde=<?php echo $_GET["fecha_desde"]?>&fhasta=<?php echo $_GET["fecha_hasta"]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Horario"></a></td>
