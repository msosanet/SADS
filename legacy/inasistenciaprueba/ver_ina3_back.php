...
?>
				<tr>
					...
					<table border="0" width="80%"><!-- +++ FORMULARIO CON DOS RENGLONES ++++ -->
						<tr>
...
<table border="1" width="950" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="80" align="center"  height="36">Justif.</td>
							<td bgcolor="#808080" width="80" align="center"  height="36">Parte</td>
							<td bgcolor="#808080" width="80" align="center"  height="36">curso/div/tur</td>
							<td bgcolor="#808080" width="80" align="center"  height="36">Oblig.</td>
...
$result4 = mysql_query ("SELECT * FROM motivos WHERE codigo = '$fila3[falta]' ");
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#EAEAEA" align="center"><?echo $observa;?></td>
							<td bgcolor="#EAEAEA" align="center"><?echo $fila2[notifico];?></td>
							<td bgcolor="#EAEAEA" align="center"><?echo $justi;?></td>
							<td bgcolor="#EAEAEA" align="center"><?echo $fila4[descripcion];?></td>
							<td bgcolor="#EAEAEA" align="center"><?echo $fila3[curso];?>/<?echo $fila3[div];?>/<?echo $fila3[turno];?></td>
       <td bgcolor="#EAEAEA" align="center"><?echo $fila3[obligaciones];?></td>
						</tr>
						<?
						}
						?>
