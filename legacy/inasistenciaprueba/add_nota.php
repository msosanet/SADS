...
$_POST['a']=date("Y");
  ...
  if (isset($_POST["submitx"])) {
     ...
     if (trim($_POST["observaciones"]) == '') { $errorobs = 1; $hayerrores = 1; };
...
<form method="POST" action="add_nota.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Cargar Notas de entrada</p>
...
<tr>
						<br><br><b>En caso de que la entrada sea un C.V. seleccionar en "Origen" la opci�n "Curriculum", en Origen extendido colocar el nombre y apellido y en Asunto colocar los datos de la carrera o titulo, telefono y mail.</b>
						...
						?>
							...
							N�:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="text" name="numero" size="15" maxlength="15" value="" autofocus/></td>
							</td>
						<?
...
<tr>
							...
							<td width="174" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Origen:</td>
						...
						?>
								...
								<td width="74" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Fecha de sello:</td>
							</font>
						...
						<?
	  					if ($errorobs==1) {$color="#FF0000";}
						else{$color="#000000";}
						?>
						<tr>
					
							<td width="174" bgcolor="#EAEAEA" align="right">Origen Extendido:</td>
						...
						?>
							...
							<td bgcolor="#EAEAEA" width="268" align="left"><TEXTAREA COLS=35 ROWS=5 NAME="asunto"> </TEXTAREA></td>
...
if (mysql_query ("INSERT INTO mesaentradas VALUES (0,'$fecha_final','$numero',$anio,$tipo,'$observaciones','$asunto','$graba','2020-03-20')"))
	{		
				...
				<meta http-equiv='refresh' content='0; URL=add_nota.php?'>
				<? 
