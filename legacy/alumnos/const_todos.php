...
<title>Constancias de alumno</title>
</head>
...
<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
	...
	<tr bgcolor="#CCCCCC">
		...
		<td width="118" align="center"  height="36">Alu reg</td>
		<td width="118" align="center"  height="36">Pase</td>							
	</tr>
...
?> 
	...
	<tr bgcolor="#EEEEEE">
		...
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="aluregu2.php?dni=<? echo $fila2[dni]; ?>" target="_blank"><img border="0" src="form.png" width="35" height="35" alt="Const. alu regular"></a></td>
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="const_pase2.php?dni=<? echo $fila2[dni]; ?>" target="_blank"><img border="0" src="form.png" width="35" height="35" alt="Const. pase"></a></td>
