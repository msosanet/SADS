...
<title>Agregar familiares a alumnos</title>
</head>
...
<form method="GET" action="unir_fami.php">
...
?> 
	...
	<tr bgcolor="#EEEEEE">
		...
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="unir_fami2.php?dni=<? echo $fila2[dni]; ?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar familiar"></a></td>
    </tr>
<?
    }
?>    
