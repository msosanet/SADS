...
<title>Cambiar DNI a familiares</title>
</head>
...
<form method="GET" action="cambiar_dni.php">

<?
include 'snipet_barramenu.php'; //COMPRUEBA EL TIPO DE USUARIO Y DESPLIEGA MENÚ DE FUNCIONES ACORDE
?>	
<br>
<p align="left" class="titulo">Buscar Familiares para cambiarle el DNI</p>
<br>
...
if (isset($_GET['muestra2'])) { 
    ...
    $_pagi_sql = "SELECT * FROM familiares WHERE apellido like'%$descripcion%' or dni like'%$descripcion%'";
    $_pagi_cuantos = 20;
...
<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
	<tr>
		...
		&nbsp;Resultado de la B&uacute;squeda del familiar</td>
	</tr>
	<tr bgcolor="#CCCCCC">
...
?> 
	...
	<tr bgcolor="#EEEEEE">
		...
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="cambiar_dni2.php?dni=<? echo $fila2[dni]; ?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cambiar DNI a los padres"></a></td>
    </tr>
<?
    }
?>    
