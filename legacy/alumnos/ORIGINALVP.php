...
<?php
		...
		for($dia=1;$dia<6;$dia++)
		{
			...
			{$c=1;
				...
				if ($c==2)
						{
							$url_materia = ($_SESSION['usuario']=="preceptor")? "ORIGINALVP.php?curso=" . $cursox . "&submitcurso=Ver+Curso" : "ORIGINAL.php?curso=" . $cursox . "&submitcurso=Grabar";
				echo "<td bgcolor='$nombrex' align='center' width='375' height='50'>";
					   ...
					   HREF="<?=$url_materia?>"><font color='white' face='arial' size='2'><strong><?echo $horita?></strong></font></a>
						<?}
						?>
						<br>
