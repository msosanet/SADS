...
<title>Novedades - modificaci&oacute;n</title>
...
<?
$_pagi_sql="SELECT novedades.*,CONCAT(apellido, ', ',nombre) AS alu FROM novedades LEFT JOIN alumno ON novedades.dni = alumno.dni WHERE borrado=1 AND fecha > MAKEDATE(YEAR(CURRENT_DATE)-1,1) ORDER BY fecha DESC,hora DESC";
	...
	<table border="1" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
		...
		?>
						...
						<tr bgcolor="#FFFFFF">
							...
							<td align="center"><?echo $fila2[alu];?></td>
