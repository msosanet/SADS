...
?>	
<br>
<p align="left" class="titulo">Buscar Alumno por Apellido para completar la ficha.</p>
<br>
...
<table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
	...
	<tr bgcolor="#CCCCCC">
		...
		<td width="118" align="center"  height="36"><b>Paso 1</b></td>
		<td width="118" align="center"  height="36"><b>Paso 2</b></td>							
	</tr>
...
?> 
	...
	<tr bgcolor="#EEEEEE">
		...
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ficha-salud.php?dni=<? echo $fila2[dni]; ?>" target="_self">Completar ficha de salud</a></td>

		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ficha2.php?dni=<? echo $fila2[dni]; ?>" target="_self">Completar inscripcion</a></td>
