<?
    ...
    function generarCodigoBarraFunc($numeroDocumento) {
        // $codigo = $numeroDocumento . $verificador;
        
        // Make Barcode object of Code128 encoding.
        $generator = new BarcodeGeneratorPNG();
        $barcode = $generator->getBarcode($numeroDocumento, $generator::TYPE_CODE_128); 
        // $barcode = (new Picqer\Barcode\Types\TypeCode128())->getBarcode($numeroDocumento);
        
        // echo "<div style=\"width: 400px; height: 75px\">" . $barcode . "</div>";
        // echo '<img src="data:image/png;base64,' . base64_encode($barcode) . '">';
        file_put_contents("codigos/barcode-".$numeroDocumento.".png", $barcode);
