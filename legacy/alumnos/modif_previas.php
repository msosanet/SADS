...
<title>Modificar registros de Materias Previas</title>
</head>
...
<form method="GET" action="modif_previas.php">

<?
include 'snipet_barramenu.php'; //COMPRUEBA EL TIPO DE USUARIO Y DESPLIEGA MENÚ DE FUNCIONES ACORDE
?>	
<br>
<p align="left" class="titulo">Buscar Alumno por Apellido para agregarle nota a la previa</p>
<br>
...
?> 
	...
	<tr bgcolor="#EEEEEE">
		...
		<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="modif_previas2.php?dni=<? echo $fila2[dni]; ?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Cargar Nota"></a></td>
    </tr>
<?
    }
?>    
