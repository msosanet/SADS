...
?>	
				<tr>
					...
					<table border="0" width="62%">
						<tr>
							<td align="right" width="36%">Ingrese el Apellido, dni o parte de el:</td>
...
{ 
	...
	$_pagi_sql="SELECT * FROM docentes WHERE apellido like'%$descripcion%' or dni like'%$descripcion%' ORDER BY apellido,nombre";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="118" align="center"  height="36">Compu</td>
							<td bgcolor="#808080" width="118" align="center"  height="36">Reloj</td>							
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ver_hs_aux.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Horario"></a></td>
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="ver_hs_aux22.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Horario"></a></td>
