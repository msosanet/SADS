...
<form method="POST" action="comunicado.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<p align="left" class="text1b">Comunicados</p>
					...
					<table border="0" width="70%" id="table1" cellpadding="2" cellspacing="4">
						...
						?>
							<td width="20%" bgcolor="#EAEAEA" align="center"><font color="<?echo $color;?>">Descripci�n del comunicado:</td>
							...
							<td bgcolor="#EAEAEA" width="10%" align="center"><?echo "A�o: " . date ("Y");  ?></td>												</tr>
						<tr height="30">
...
mysql_query ("INSERT INTO comunicado VALUES (0,'$asunto','$agente','$anio','$now')");


$resultnotas = mysql_query ("select * from comunicado order by codigo desc limit 1");
$filanotas = mysql_fetch_array($resultnotas); 


				?>
				<script>
				var answer=alert("Comunicado:<? echo $filanotas["codigo"];?> ")
				</script> 
