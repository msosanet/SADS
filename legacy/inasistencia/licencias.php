...
$resultrr = mysql_query ("SELECT * FROM alta_baja where docente='$dni' and activa=1");
    ...
    foreach ($valoresSeleccionados as $valor) 
{
		...
		if (mysql_query ("INSERT INTO ausentes2 VALUES (0,'$dni','$fecha_desde','$fecha_hasta','$hora','$motivo','$graba','$observaciones','$now',1,0,$nomostrar,$nopizarra,$valor1,$valor2,$valor3)"))
			...
			if ($fecha_hasta =="0000-00-00" or $fecha_hasta > $now){

			mysql_query ("UPDATE alta_baja SET activa=0 WHERE materia=$valor2 and activa = 1");
