...
$cont=0;		?> <table border='1' id='customers' style='width: 50%;'>
		...
		?> 
						...
						<tr>
							...
							<td align="center"><?echo $fila2[dni];?></td>
							<td align="center"><?php echo date("d-m-Y", strtotime($fila2['fecha'])); ?></td>
							<td align="center"><?echo $fila2[tipo];?></td>
							<td align="center"><?echo $injus;?></td>					
