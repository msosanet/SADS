...
$error = true; // Asumimos error hasta que se confirme la inserción exitosa
...
if (!$error) {
    echo "<script>alert('Se ha cargado el parte del día $fechaxxx para el curso $cursodescx');</script>";
    echo "<meta http-equiv='refresh' content='0; URL=selcurhorpartes2.php'>";
} else {
    echo "<script>alert('Ocurrió un error al cargar el parte.');</script>";
}
