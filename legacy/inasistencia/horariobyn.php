...
<form method="GET" action="ORIGINAL.php">
 ...
 <div align="center">
	...
	<tr>
		<td width="895" bgcolor="#EAEAEA" align="center" colspan="7">Horario de  <?=$rr['descripcion']; ?></td>
	</tr>
	<tr>
...
<?php
		...
		for($dia=1;$dia<6;$dia++)
		{
			...
			{$c=1;
				...
				if ($c==2)
						{
				echo "<td align='center' width='375' height='50'>";
						?>

						<a onMouseOver="javascript:highlightLink(this, '#FFFF00');"
					   onMouseOut="javascript:unhighlightLink(this);"
					   HREF="ORIGINAL.php?curso=<?echo $cursox?>&submitcurso=Grabar"><strong><?echo $horita?></strong></a>
						<?}
						?>
						<br>
						<a onMouseOver="javascript:highlightLink(this, '#00FF00');"
					   onMouseOut="javascript:unhighlightLink(this);"
					   HREF="ORIGINALVD.php?actor=<?echo $nombrex?>&submitcurso=Grabar"><?echo $docx?></a>
						<?
			...
			else
			{
				$docx="&#60;SIN PROFESOR&#62;";
				$nombrex="FC0303";
				echo "<td style='text-align:center;' width='375' height='50'>";
				?>
				<a onMouseOver="javascript:highlightLink(this, '#FFFF00');"
				   onMouseOut="javascript:unhighlightLink(this);"
				   href="ORIGINAL.php?curso=<?=$cursox?>&submitcurso=Grabar"><span style="font-weight: bold;font-family: Arial, Helvetica, sans-serif" ><?=$horita?></span></a>
				<br>
				<a onMouseOver="javascript:highlightLink(this, '#00FF00');"
				   onMouseOut="javascript:unhighlightLink(this);"
				   href="ORIGINALVD.php?actor=<?=$nombrex?>&submitcurso=Grabar"><span style="color:#ffffff;background-color:#bbbbbb;font-weight: bold;font-family: Verdana, Helvetica, sans-serif" ><?=$docx?></span></a>
				<?
				echo "</td>";
			}
			}
...
<?php
			...
			while ($fila80 = mysql_fetch_array($result80))
				...
				?>
					...
					<td bgcolor="#eeee" align="center"><strong><?=$fila80['nombredoc'];?></td></strong></a>
					</tr>
<?php
				}
?>
