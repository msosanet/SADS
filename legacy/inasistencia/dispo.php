...
?>	
				<tr>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						?>
							<td width="174" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Descripci�n de la disposicion:</td>
							...
							<td width="174" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">A�o:</td>
							<td bgcolor="#EAEAEA" width="268" align="left">
							<?echo date ("Y");  ?>
							</td>
...
else
{
	...
	$sqlcuente="SELECT COUNT(*) as ultimo,anio FROM disponueva WHERE anio=YEAR(NOW()) GROUP BY anio";
	...
	if (mysql_query ("INSERT INTO disponueva VALUES ('',$ultimo,'$asunto','$agente','$anio','$dia','')"))
...
$filanotas = mysql_fetch_array($resultnotas); */
				?>
				<script>
				var answer=alert("Disposicion:<? echo $ultimo;?> ")
				</script> 
