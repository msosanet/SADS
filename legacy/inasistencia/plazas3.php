...
$(document).ready(function() {
    ...
    $("#busqueda").on("input", function() {
        ...
        delayTimer = setTimeout(function() {
            var valor = $("#busqueda").val().trim(); // Obtener el último valor del input

            // Si el valor es menor a 2 caracteres, no realizar la búsqueda
            if (valor.length < 2) {
                $.ajax({
                    url: "buscar_plazas.php",
                    method: "GET",
                ...
                return; // Salir si no se cumple la longitud mínima
            }

            // Enviar la búsqueda con el último valor del input
            $.ajax({
                url: "buscar_plazas.php",
                method: "GET",
