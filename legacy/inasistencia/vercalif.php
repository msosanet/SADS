...
<div align="center">		
<?
echo "<form method='POST' action='vercalif.php' >	";
	echo "<br><br>";
...
if(isset($_POST["submitcurso"]))
{
	...
	echo "<table border=3 id='customers'>";
		...
		echo "</tr>";
		//print_r($array);
		$sqlalu="SELECT * FROM alumno a,calificador c,curso2 cc, cursa cu WHERE cu.alumno=c.dni AND cu.control='1' AND cu.anio=$cicloLect AND c.dni=a.dni AND cc.idcurso='$curso' AND cc.idcurso=c.curso AND cc.habilitado='1' AND cc.curso=cu.curso AND cc.division=cu.divi GROUP BY c.dni ORDER BY a.apellido,a.nombre ASC";
