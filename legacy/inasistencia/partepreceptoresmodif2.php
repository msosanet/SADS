...
<form method="GET" action="partepreceptoresmodif2.php" target="_self">
<tr>
...
$consulta="SELECT PP.hora,M.descripcion as materia,CONCAT(D.apellido, ' ', D.nombre) as nombredoc,PP.estado,C.descripcion,PP.observaciones,D.dni FROM partepreceptores2 PP, docentes D, materias M, curso3 C WHERE PP.fecha='$fecha' AND PP.curso='$curso' AND PP.curso=C.idcurso AND M.idmateria=PP.materia AND PP.docente=D.dni ORDER BY PP.hora ASC";
echo $consulta;
