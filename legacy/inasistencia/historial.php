...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Consultar alumnos por nombre y apellido.</p>
						</p>
					<p align="center">&nbsp;
...
{ 
	...
	$_pagi_sql="SELECT DISTINCT dni,alumnos.alumno,alumnos.curso,alumnos.division,alumnos.tel FROM intervencion, alumnos WHERE alumnos.alumno LIKE '%$descripcion%' AND alumnos.dni = intervencion.alumno";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="118" align="center"  height="36">Historial</td>							
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="historial2.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Derivar"></a></td>
