...
{ 
	...
	$_pagi_sql="SELECT * FROM m_salud_cformsdata WHERE field_name='Profesión' and field_val like'%$descripcion%'";
...
<br><br>
		...
		{	
			...
			$result6 = mysql_query ("SELECT * FROM  m_salud_cformsdata WHERE field_name='Profesión' and sub_id=$fila2[sub_id]");
