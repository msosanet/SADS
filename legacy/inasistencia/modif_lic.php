...
<form method="_GET" action="modif_lic.php?docen=<? echo $docen; ?>&id=<? echo $id; ?>">
</p>
<div align="center">
				...
				<tr>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						<? 	$valor2="SELECT * FROM materia_cargo order by id ASC";
							...
							Fecha inicio:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="date" name="fecha3" size="10" maxlength="10" value="<?echo $filatt['f_notif']; ?>"/></td>
							</td>

						<tr>
							<td width="190" bgcolor="#EAEAEA" align="right">
							Fecha Alta:</td>
							<td bgcolor="#EAEAEA" width="265" align="left"><input type="date" name="fecha1" size="10" maxlength="10" value="<?echo $filatt['fecha_desde']; ?>"/></td>
							</td>
						...
						?>
						  ...
						  <td bgcolor="#EAEAEA" width="268" align="left">
                        			...
                        			<? 	$valor="SELECT * FROM motivo order by codigo";
							menu2($valor,$filatt[motivo],'descripcion'); ?>
...
else
{
	...
	if (empty($_GET['activo'])) $activo=0;
	else $activo=1;
	//echo "Activo2:".$activo;

//echo $activo;
$updateab="UPDATE alta_baja SET materia=$materia, fdesde='$fecha_desde', fhasta='$fecha_hasta', finicio='$fecha_inicio', obs='$observaciones', sit_revista=$caracter, enviado=$enviado,activa='$activo' where docente=$docen and id=$id";
//echo $updateab;
