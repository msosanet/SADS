...
$rr = mysql_query ("SELECT * FROM docentes where dni='$dni'");
...
?>	
				<tr>
					...
					<td>
					<br>
					<p align="left" class="text1b">Asignaci�n de N� legajo a <?php echo $rr[apellido]; ?>, <?php echo $rr[nombre]; ?></p> <br>
...
<br><br><br>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						<td width="150" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">N� Legajo:</td>
							</font>
