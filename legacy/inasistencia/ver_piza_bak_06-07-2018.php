...
{ 
	...
	$_pagi_sql="SELECT * FROM ausentes WHERE fecha_desde >='$fecha_desde' and fecha_hasta <= '$fecha_hasta' and identificacion=1 and motivo!=32 and motivo!=34 AND motivo <> '47' AND motivo <> '52' AND motivo <> '15' AND motivo <> '29' AND motivo <> '42' and veo=0 order by codigo";
...
<table border="0" width="900" bordercolor="#dddddd" cellspacing="0"><!-- EMPIEZA CUADRO DE HORARIOS -->
   <tr>
       <td colspan="6" align="center" class="text1b" bgcolor="#BBAAAA"> Resultado del Filtro del <font color="#D08230"><? echo $fecha_invert1 ." hasta el " . $fecha_invert2; ?></font>
...
?>        
            ...
            <table width="135" border="1" cellspacing="0"><!-- HORARIOS DEL LUNES -->
...
?>        
            ...
            <table width="135" border="1" cellspacing="0"><!-- HORARIOS DEL MARTES -->
...
?>        
            ...
            <table width="135" border="1" cellspacing="0">
...
<br>
<!-- ******************* FIN NUEVA PROPUESTA DE PIZARRA ************************* -->             
