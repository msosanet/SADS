...
$resultmotivo = mysql_query ("SELECT * FROM matcurfran, materias where matcurfran.idcurso=$curso and matcurfran.idmateria=materias.idmateria"); 
...
<table border="0" width="100%">
    <tr align="right">
        <td class="titulo" align="left">Altas MOV.</td>
        <td>                                                                     
            <form method="GET" action="asigdocfran.php?dni=<? echo $dni; ?>">
...
<form method="POST" action="asigdocfran.php?curso=<? echo $curso . "&ident=1"; ?>&dni=<? echo $dni; ?>">
