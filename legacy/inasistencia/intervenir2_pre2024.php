...
$result1 = mysql_query ("SELECT * FROM derivacion where id=$id");
...
<form method="POST" action="intervenir2.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<td>
					<br>
					<p align="left" class="text1b">Cargar intervencion de <? echo $filadocente['alumno'] ?></p>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="0">
						...
						FECHA DE NACIMIENTO: <?echo  $filadocente['fechanac'];?><br><br>
						HECHOS: <?echo  $fila1['hechos'];?><br>
						DERIVADOR: <?echo  $fila1['observador'];?><br>
						...
						<tr>
							...
							<td width="174" bgcolor="#EAEAEA" align="right" colspan="2">Tareas:</td>
...
if (mysql_query ("INSERT INTO intervencion VALUES (0,'$observaciones','$profesional','$fecha','$alumno')"))
	{		
