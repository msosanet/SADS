...
<form method="GET" action="tarde-pomy.php">
...
{ 
	...
	$_pagi_sql="SELECT * FROM diario,docentes WHERE diario.fecha >='$fecha_desde'  and diario.fecha <= '$fecha_hasta'  and diario.tipo='Entrada'  and docentes.identificacion=2 and diario.dni=docentes.dni order by diario.dni";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							<td width="100" bgcolor="#ffffff" align="center" height="36"><b>Apellido y Nombre</td></b>
							<td bgcolor="#ffffff" width="100" align="center" height="36"><b>Fecha</td></b>
							<td bgcolor="#ffffff" width="100" align="center" height="36"><b>Entrada a cumplir</td></b>
							<td bgcolor="#ffffff" width="100" align="center" height="36"><b>Entrada real</td></b>
							<td bgcolor="#ffffff" width="100" align="center" height="36"><font color="red"><b>Tarde</td></b></font>
							<td bgcolor="#ffffff" width="100" align="center" height="36"><b>Salida a cumplir</td></b>
							<td bgcolor="#ffffff" width="100" align="center" height="36"><b>Salida real</td></b>
		...
		{	
			...
			$restar=restaHoras($filaobs[hs_entrada],$fila2[horario]);

			if ($pasa < 0) {

			if ( $pasa < $tolerancia){
			$resta=$filaobs3[horario]-$fila2[horario];
			$resultobs2 = mysql_query ("SELECT apellido, nombre FROM docentes WHERE dni = '$fila2[dni]' and identificacion=2");
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center">
							<font color="red"><b><?echo $restar;?></b></font>
							</td>
							<td width="20" bgcolor="#EAEAEA" align="center">
