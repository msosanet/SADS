<?php
// Obtener el criterio de búsqueda desde GET
...
echo "<h2>Resultados de la búsqueda para el criterio aproximado: $criterio</h2>";
if (!empty($resultados)) {
    echo "<ul>";
