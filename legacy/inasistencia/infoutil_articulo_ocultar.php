...
?>
<!-- ++++++++++ FIN CARGA REGISTRO A OCULTAR ++++++++++++ -->

<!-- *********** FORMULARIO ARTICULO A OCULTAR ***************** -->
<div id="nov_form_container" align="left">

<form name="form1" method="post" action="infoutil_articulo_ocultar.php">

    <p class="titulo2" align="center">OCULTAR ART&Iacute;CULO</p>
    <hr>
    <p>&nbsp;</p>
    ...
    <p><input type="submit" name="update" value="     Ocultar     "></p>
...
<?
    ...
    if(isset($_POST['update'])) {
        ...
        } else
        {
            ...
            $result = mysqli_query($mysqli, "UPDATE infoutil SET titulo = '$titulo', orden = '$orden', grupo = '$grupo', detalle = '$detalle', fecha = '$fecha', grabo  = '$grabo', ocultar = '1' WHERE id = $id");

            //*************** MUESTRA MENSAJE GRABACIÓN EXITOSA **************
            echo "<font color='green'>Aviso ocultado correctamente.<br></font>";
        }
    }
?>
