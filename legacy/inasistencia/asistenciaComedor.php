                ...
                <?
                    ...
                    if(isset($_GET['anular']) && isset($_GET['id'])) {
                        ...
                        if(mysql_query($sql)) {
                            ...
                            echo "Error al actualizar registro: " . mysql_error();
                        }
                    }
           ...
           <!--     <p style="background-color: red; color: white" align="center" class="titulo">NO USAR - MODULO EN DESARROLLO</p> -->
                ...
                <?
                    ...
                    //     $descripcion = $_GET['descripcion'];
                        $_pagi_sql = "SELECT a.apellido, a.nombre, a.dni,c.id,c.fecha,c.permitido FROM alumno as a JOIN comedor_asistencia as c ON a.dni = c.dni_alumno WHERE fecha = CURRENT_DATE  ORDER BY c.fecha,c.id DESC";
                        $_pagi_cuantos = 20;
