...
<form method="POST" action="mod_cargos.php">
</p>
<div align="center">
...
<br><br>
	...
	<tr>
		...
		?>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Entrada:<input type="text" name="le" size="8" maxlength="8" value="<?echo $fila[hs_entrada]; ?>" /></font></td>
		<?
	  		if ($errorme==1) {$color="#FF0000";}
			else{$color="#000000";}
		?>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Entrada:<input type="text" name="me" size="8" maxlength="8" value="<?echo $fila2[hs_entrada]; ?>" /></font></td>
		<?
	  		if ($errormie==1) {$color="#FF0000";}
			else{$color="#000000";}
		?>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Entrada:<input type="text" name="mie" size="8" maxlength="8" value="<?echo $fila3[hs_entrada]; ?>" /></font></td>
		<?
	  		if ($errorje==1) {$color="#FF0000";}
			else{$color="#000000";}
		?>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Entrada:<input type="text" name="je" size="8" maxlength="8" value="<?echo $fila4[hs_entrada]; ?>" /></font></td>
		<?
	  		if ($errorve==1) {$color="#FF0000";}
			else{$color="#000000";}
		?>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Entrada:<input type="text" name="ve" size="8" maxlength="8" value="<?echo $fila5[hs_entrada]; ?>" /></font></td>
<?
	  		if ($errorve==1) {$color="#FF0000";}
			else{$color="#000000";}
		?>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Entrada:<input type="text" name="sa" size="8" maxlength="8" value="<?echo $fila6[hs_entrada]; ?>" /></font></td>

	</tr>
	<tr>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Salida:<input type="text" name="ls" size="8" maxlength="8" value="<?echo $fila[hs_salida]; ?>" /></font></td>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Salida:<input type="text" name="ms" size="8" maxlength="8" value="<?echo $fila2[hs_salida]; ?>" /></font></td>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Salida:<input type="text" name="mis" size="8" maxlength="8" value="<?echo $fila3[hs_salida]; ?>" /></font></td>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Salida:<input type="text" name="js" size="8" maxlength="8" value="<?echo $fila4[hs_salida]; ?>" /></font></td>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Salida:<input type="text" name="vs" size="8" maxlength="8" value="<?echo $fila5[hs_salida]; ?>" /></font></td>
		<td bgcolor="#EAEAEA"><font color="<?echo $color;?>">Hs Salida:<input type="text" name="sab" size="8" maxlength="8" value="<?echo $fila6[hs_salida]; ?>" /></font></td>
	</tr>
	<tr>
...
if (trim($lunes) <> '' OR trim($lunes2) <> '')	{
								mysql_query ("UPDATE horarios SET  WHERE dni='$dni' and cod_dia=1");
							}
if (trim($martes) <> '' OR trim($martes2) <> '')	{
								mysql_query ("UPDATE horarios SET  WHERE dni='$dni' and cod_dia=2");
							}
if (trim($miercoles) <> '' OR trim($miercoles2) <> '')	{
								mysql_query ("UPDATE horarios SET  WHERE dni='$dni' and cod_dia=3");
							}
if (trim($jueves) <> '' OR trim($jueves2) <> '')	{
								mysql_query ("UPDATE horarios SET  WHERE dni='$dni' and cod_dia=4");
							}
if (trim($viernes) <> '' OR trim($viernes2) <> '')	{
								mysql_query ("UPDATE horarios SET  WHERE dni='$dni' and cod_dia=5");
							}
if (trim($sabado) <> '' OR trim($sabado2) <> '')	{
								mysql_query ("UPDATE horarios SET  WHERE dni='$dni' and cod_dia=6");
							}
...
?>
				<script>
				var answer=alert("Se actualiz� en la BD")
				</script> 
