...
<?php 		
		...
		*/
		...
		{ 	
			...
			//                          SELECT m.descripcion,m.idmateria FROM horariox h,materias m WHERE h.idmateria=m.idmateria AND h.idcurso=$cursox and h.dia=$dia and h.hora=$hora AND h.idmateria!=65");
			...
			if ($elegidox!=0)
			{
			  ...
			  //                        SELECT CONCAT(D.apellido,  ' ', D.nombre) as nombredoc,D.dni FROM docente D, matcur mc WHERE mc.idcurso=$cursox AND mc.idmateria=$matx AND mc.iddocente=D.dni AND D.dni!='0'"	
