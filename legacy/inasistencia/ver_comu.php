...
<form method="GET" action="ver_comu.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Buscar Comunicados por Asunto.</p>
						</p>
					<p align="center">&nbsp;
	...
	$_pagi_sql="SELECT * FROM comunicado WHERE descripcion like '%$descripcion%' or codigo like '%$descripcion%' ";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							<td width="20" bgcolor="#808080" align="center" height="36">Num. Comunicado</td>
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="modif_comu.php?nota=<?php echo $fila2[codigo]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Modificar Comunicado"></a></td>
