...
<title>INFRAESTRUCTURA - OCULTAR TICKET</title>
...
<form name="form1" method="post" action="infra_tkt_ocultar.php">

    <p align="center" class="titulo">TICKET A OCULTAR</p>
    <hr>
