...
$resultdocente2 = mysql_query ("SELECT * FROM motivos order by descripcion");
...
<form method="GET" action="ver_enf.php?actor=<?php echo $dni?>">
...
?>
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Filtrar por Enfermedad</p>
						</p>
					<p align="center">&nbsp;
					...
					<table border="0" width="100%">
						...
						<tr>
					<td width="74" bgcolor="#EAEAEA" align="right">Motivo de enfermedad </td>
					<td><select size="1" name="enf">
...
{ 
	...
	$_pagi_sql="SELECT DISTINCT dni,docente,motivo FROM ausentes, docentes WHERE ausentes.fecha_desde >='$fecha_desde' and ausentes.fecha_hasta <= '$fecha_hasta' and ausentes.motivo=$enf and ausentes.docente=docentes.dni order by docentes.apellido";
...
<br><br>
		...
		?> <table border="1" width="980" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						<tr>
							...
							&nbsp;Resultado del Filtro por Enfermedad</td>
						</tr>
						<tr>
							<td bgcolor="#808080" width="100" align="center" height="36">DNI</td>
		...
		<?php while ($fila22 = mysql_fetch_array($_pagi_result))
		{	
			$resultobs = mysql_query ("SELECT * FROM docentes WHERE dni = '$fila22[docente]' ");
			$filaobs = mysql_fetch_array($resultobs);

		
			$resultmot = mysql_query ("SELECT * FROM motivos WHERE codigo = '$fila22[motivo]' ");
		...
		?> 
						...
						<tr>
							<td width="20" bgcolor="#EAEAEA" align="center"><a href="leg_unif.php?actor=<?echo $fila22[docente];?>" target="_blank"><?echo $fila22[docente];?></a></td>
