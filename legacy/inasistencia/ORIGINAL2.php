...
?>	
	...
	<br><br><div align='center'><h2 style="color: red;"><?php echo checkqhoras($cursox); ?></h2></div><br>
		<div align='center'>
			...
			echo "<tr>";
				...
				$horax=$desde."-".$hasta;
					...
					for($dia=1;$dia<=5;$dia++)
						...
						$mat="SELECT * FROM materia_cargo WHERE curso='$cur' AND division='$div' AND nombre!='Educación Física' AND codigo='852' ORDER BY nombre ASC";
						...
						{ 	
							...
							//$elegido = mysql_num_rows($consulta);
									...
									$flagm=1;
										...
										{
											echo "<option value=".$fila79['id']." selected>".$fila79['id']."-".$fila79['nombre']."</option>";											
										}
										else 
										{
											echo "<option value=".$fila79['id'].">".$fila79['id']."-".$fila79['nombre']."</option>";
										}
