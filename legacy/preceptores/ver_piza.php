...
?>
		...
		<div style="overflow-y: scroll; max-width:980px; max-height: 500px">
			<table id="tableam">
				<thead><tr><?PHP foreach($cabeceras as $col) echo "<th bgcolor='#808080' align='center' height='36'>" . $col . "</th>\n";?></tr><thead>
				<?PHP foreach ($listados[0] as $linea ) echo "<tr>" . implode($linea) . "</tr>\n";?>
				<tfoot><tr><?PHP foreach($cabeceras as $col) echo "<th bgcolor='#808080' align='center' height='36'>" . $col . "</th>\n";?></tr></tfoot>
			</table>
		</div>
		<br><br>
