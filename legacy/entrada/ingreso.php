...
<form method="GET" action="ingreso.php" name="mio">
	...
	<table border="0" width="980" bgcolor="#FFFFFF">
		<tr>
			...
			<table border="0" width="980">
				...
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Ingresar la Entrada. - Ingrese su N&uacute;mero de Documento (Sin puntos).</p>
						</p>
					<p align="center">&nbsp;
