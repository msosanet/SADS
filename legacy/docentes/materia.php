...
<form method="GET" action="materia.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Consultar Materias.</p>
						</p>
					<p align="center">&nbsp;
...
{ 
	...
	$_pagi_sql="SELECT * FROM materia WHERE nombre like'%$descripcion%'";
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							<td width="20" bgcolor="#808080" align="center" height="36">Codigo</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Nombre</td>
							<td bgcolor="#808080" width="200" align="center" height="36">Curso</td>
							<td bgcolor="#808080" width="118" align="center"  height="36">Div</td>
							<td bgcolor="#808080" width="118" align="center"  height="36">Turno</td>
							<td bgcolor="#808080" width="118" align="center"  height="36">Plan</td>
		...
		{
		$resultxx = mysql_query ("SELECT * FROM turno WHERE codigo = $fila2[turno]");
		$filaxx = mysql_fetch_array($resultxx) ;
		$resultplan = mysql_query ("SELECT * FROM plan WHERE codigo = $fila2[plan]");
		$filaplan = mysql_fetch_array($resultplan) ;
		...
		?> 
						...
						<tr>
							...
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $filaxx[descripcion];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $filaplan[descripcion];?></td>
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="materia2.php?actor=<?php echo $fila2[codigo]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Horario"></a></td>
