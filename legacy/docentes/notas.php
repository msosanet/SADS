...
?>	
				<tr>
					...
					<table border="0" width="895" id="table1" cellpadding="0" cellspacing="4">
						...
						?>
							<td width="174" bgcolor="#EAEAEA" align="right"><font color="<?echo $color;?>">Descripci�n de la Nota:</td>
							<td bgcolor="#EAEAEA" width="268" align="left">
							<input type="text" name="asunto" size="50" maxlength="500" value="<?echo $_POST['asunto']; ?>" />
							</td>
...
mysql_query ("INSERT INTO notas VALUES (0,'$asunto','$agente','$anio')");
...
$filanotas = mysql_fetch_array($resultnotas); 
				...
				?>
				<script>
				var answer=alert("Nota:<? echo $filanotas["codigo"];?> ")
				</script> 
