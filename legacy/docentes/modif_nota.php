...
$resultt = mysql_query ("SELECT * FROM notas WHERE codigo = '$actor'");
...
?>
				<tr>
					...
					<p align="left" class="text1b">Modificar Notas</p>
...
if (mysql_query ("UPDATE notas SET descripcion='$descripcion', agente='$agente' where codigo='$actor'"))
{	
				?>
				<script>
