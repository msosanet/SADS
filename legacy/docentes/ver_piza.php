...
{ 
	...
	$_pagi_sql="SELECT * FROM ausentes WHERE fecha_desde >='$fecha_desde' and fecha_hasta <= '$fecha_hasta' and identificacion=1 and motivo!=32 and motivo!=34 order by codigo";
							...
							<td width="20" bgcolor="#EAEAEA" align="center">
								<? if (date("w", strtotime($fila2[fecha_desde]))==1) 
									...
									?><b>	<?if ($filaobs[dni]=="00000000"){ echo $observa; }
										...
										<b> <?if ($fila2[motivo]==16){ ?><font color="#0099FF"> (Tarde)</font> <?}?></b>
