...
{ 
	...
	$_pagi_sql="SELECT * FROM diario WHERE fecha >='$fecha_desde'  and fecha <= '$fecha_hasta' and dni='$actor' order by fecha";
...
<br><br>
		...
		?> 
					...
					<tr>
						...
						<p style="margin-top: 0; margin-bottom: 0"><?php echo $fila2[tipo]?></td>
