...
<form method="POST" action="calificadores2.php">
</p>
<div align="center">
...
?>	
				<tr>
					...
					<td>
					<br>
					<p align="left" class="text1b">Alta de Calificador</p>
...
<b>Seleccione el plan, curso y materia para cargar los clasificadores</b><br>
...
<br><br>
						...
						<tr>
							<td width="895" bgcolor="#EAEAEA" align="center" colspan="7"><br>
							<p align="center"><input type="submit" value="     Siguiente     " name="submitx" style="border: 1px solid #C0C0C0; padding-right: 3px; background-color: #EBEBEB; font-weight:700; float:center" /></td>
...
else
{
	...
	?><meta http-equiv='refresh' content='0; URL=calificadores3.php?plan=<?echo $plan?>&curso=<?echo $curso?>&materia=<?echo $materia ?>'><?
