...
<form method="GET" action="buscar_mat.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Realizar un movimiento</p>
						</p>
					<p align="center">&nbsp;
...
<br><br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						...
						<tr>
							...
							<td bgcolor="#808080" width="118" align="center"  height="36">Baja</td>								
		...
		?> 
						...
						<tr>
							<td width="200" bgcolor="#EAEAEA" align="center"><?echo $fila2[nombre];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[curso];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $fila2[div];?></td>
							<td width="20" bgcolor="#EAEAEA" align="center"><?echo $filaz[descripcion];?></td>
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="alta_matdoc.php?materia=<?php echo $fila2[codigo]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="ALTA"></a></td>
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="movimiento2.php?materia=<?php echo $fila2[codigo]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="BAJA"></a></td>
