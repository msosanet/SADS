...
<form method="GET" action="docente_consul.php">
...
?>	
				<tr>
					<td>
					<p align="center"><div class="titles1">&nbsp;<p align="left">Consultar cursos por docente.</p>
						</p>
					<p align="center">&nbsp;
...
{ 
	...
	$_pagi_sql="SELECT * FROM docente WHERE apellido like'%$descripcion%'";
...
<br>
		...
		?> <table border="1" width="900" id="table1" cellpadding="0" cellspacing="0" bordercolor="#C0C0C0">
						<tr>
							...
							visto la licencia presentada por <?echo $fila2[apellido];?><?echo $fila2[nombre];?> con DNI N&ordm;<?echo $fila2[dni];?> situacion de revista<?echo $estado[descripcion];?></td>
						</tr>
						<tr>
		...
		{
$resultestado = mysql_query ("SELECT * FROM estado WHERE codigo = $fila2[numero]");
$estado = mysql_fetch_array($resultestado);
		...
		?> 
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="55" align="center" bordercolor="#C0C0C0"><a href="curso.php?actor=<?php echo $fila2[dni]?>" target="_self"><img border="0" src="form.png" width="35" height="35" alt="Ver Horario"></a></td>
						</tr>
						<?
						}
						?>
	...
	?>					
					...
					<span class="text1b">visto la licencia presentada por <?echo $fila2[apellido];?><?echo $fila2[nombre];?> con DNI N&ordm;<?echo $fila2[dni];?> situacion de revista<?echo $estado[descripcion];?></span>
					<p align="center">&nbsp;</td>
				</tr>
	...
	?>
            ...
            <span class="text1b">visto la licencia presentada por <?echo $fila2[apellido];?><?echo $fila2[nombre];?> con DNI N&ordm;<?echo $fila2[dni];?> situacion de revista<?echo $estado[descripcion];?></span>			</div>
			<?
			include 'footer.php';
			?>
