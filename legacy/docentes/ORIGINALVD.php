...
<?php 		
		...
		{ 	
			...
			?>	
               ...
               HREF="http://docentes.colegiosobral.edu.ar/ORIGINAL.php?curso=<?echo $cursoxx?>&submitcurso=Grabar"><font face='arial' size='2'><strong><?echo $fila81['descripcion']?></strong></font></a>
			<?	
			...
			<a onMouseOver="javascript:highlightLink(this, '#00FF00');" 
			   onMouseOut="javascript:unhighlightLink(this);" 
			   HREF="http://docentes.colegiosobral.edu.ar/asigdoc.php?curso=<?echo $cursox?>&submitcurso=Grabar"><font face='verdana' size='1'><?echo $docx?></font></a>
			<br>
			<a onMouseOver="javascript:highlightLink(this, '#00FF00');" 
			   onMouseOut="javascript:unhighlightLink(this);" 
			   HREF="http://docentes.colegiosobral.edu.ar/asigdoc.php?curso=<?echo $cursox?>&submitcurso=Grabar"><font face='verdana' size='0.5'><?echo $cursito?></font></a>
